...
{
    public partial class ProvidentEmployeeFormatForm : Form
    {
        private IDAL dal;
        ...
        public ProvidentEmployeeFormatForm(string month,string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = ProvidentReturnsEmployeeFormat1.Database;
        ...
        public ProvidentEmployeeFormatForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void ProvidentEmployeeFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
