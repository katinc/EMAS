...
{
    public partial class StaffDetailedProfile : Form
    {
        private IDAL dal;
        ...
        public StaffDetailedProfile(string staffID)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = staffDetailedProfileReport1.Database;
        ...
        private void StaffDetailedProfile_Load(object sender, EventArgs e)
        {
            try
            {
