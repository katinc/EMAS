...
{
    public partial class DepartmentsReportForm : Form
    {
        private IDAL dal;
        public DepartmentsReportForm()
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            Database mydatabase = Departments1.Database;
        ...
        private void DepartmentsReportForm_Load(object sender, EventArgs e)
        {
            try
            {
