...
{
    public partial class LeaveRoasterReportSelect : Form
    {
        ...
        public LeaveRoasterReportSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void LeaveRoasterReportSelect_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                reportForm = new LeaveRoasterReportForm(txtStaffNo.Text.Trim(), cboLeaveType.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                reportForm.Show();
            }
            catch (Exception ex)
            {
