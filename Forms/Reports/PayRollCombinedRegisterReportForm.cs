...
{
    public partial class PayRollCombinedRegisterReportForm : Form
    {
        ...
        public PayRollCombinedRegisterReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised,string bank, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayrollCombineRegisterReport1.Database;
        ...
        public PayRollCombinedRegisterReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PayRollCombinedRegisterReportForm_Load(object sender, EventArgs e)
        {
            try
            {
