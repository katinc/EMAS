...
{
    public partial class StatisticsAgeDistributionByGradeForm : Form
    {
        private IDAL dal;
        ...
        public StatisticsAgeDistributionByGradeForm(bool isAsAtDateChecked, DateTime asAtDate)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StatisticsAgeDistributionByGrade1.Database;
        ...
        public StatisticsAgeDistributionByGradeForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StatisticsAgeDistributionByGradeForm_Load(object sender, EventArgs e)
        {
            try
            {
