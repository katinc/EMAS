...
{
    public partial class BirthDayLetersForm : Form
    {
        private IDAL dal;
        ...
        public BirthDayLetersForm(bool isAsAtDateChecked, DateTime asAtDate, decimal ageFrom, decimal ageTo, DateTime monthselect)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffBirthDayLetter1.Database;
        ...
        private void BirthDayLetersForm_Load(object sender, EventArgs e)
        {
            try
            {
