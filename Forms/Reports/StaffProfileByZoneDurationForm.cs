...
{
    public partial class StaffProfileByZoneDurationForm : Form
    {
        private IDAL dal;
        ...
        public StaffProfileByZoneDurationForm(bool isAsAtDateChecked, DateTime asAtDate, decimal ageFrom, decimal ageTo, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffProfileByZoneDuration1.Database;
        ...
        public StaffProfileByZoneDurationForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffProfileByZoneDurationForm_Load(object sender, EventArgs e)
        {
            try
            {
