...
{
    public partial class StaffChangeNameForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeNameForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangeNameReport1.Database;
        ...
        private void StaffChangeNameForm_Load(object sender, EventArgs e)
        {
            try
            {
