...
{
    public partial class BankAdviceSlipSummaryForm : Form
    {
        private IDAL dal;
        ...
        public BankAdviceSlipSummaryForm(string staffID, string month, string year, string zone,string department,string unit,string gradeCategory,string grade, string bank, string bankBranch, string accountType, string accountNumber,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = BankAdviceSlipSummary1.Database;
        ...
        public BankAdviceSlipSummaryForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void BankAdviceSlipSummaryForm_Load(object sender, EventArgs e)
        {
            try
            {
