...
{
    public partial class SummaryReportFormUnit : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        public SummaryReportFormUnit(string department, bool pieChart, bool barChart, bool doughnut, int totalStaff, int unitCount)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "UnitCount";
                paramDiscreteValue.Value = unitCount;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = SummaryReportUnit1.Database;
