...
{
    public partial class SSNITReturnsReportForm : Form
    {
        private IDAL dal;
        ...
        public SSNITReturnsReportForm(string month, string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = ssnitReturns1.Database;
        ...
        private void SSNITReturnsReportForm_Load(object sender, EventArgs e)
        {
            try
            {
