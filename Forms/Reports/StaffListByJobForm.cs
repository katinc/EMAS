...
{
    public partial class StaffListByJobForm : Form
    {
        private IDAL dal;
        ...
        public StaffListByJobForm(bool isAsAtDateChecked, DateTime asAtDate, string gender, string department, string unit, string zone, string jobTitle, string gradeCategory, string grade, bool staffNoBy, bool nameBy, bool departmentBy)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "JobTitle";
                paramDiscreteValue.Value = jobTitle;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "StaffNoBy";
                paramDiscreteValue.Value = staffNoBy;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);

                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "NameBy";
                paramDiscreteValue.Value = nameBy;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);

                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "DepartmentBy";
                paramDiscreteValue.Value = departmentBy;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = StaffProfileByJobTitle1.Database;
        ...
        private void StaffListByJobForm_Load(object sender, EventArgs e)
        {
            try
            {
