...
{
    public partial class StaffProfileByGradeForm : Form
    {
        private IDAL dal;
        ...
        public StaffProfileByGradeForm(string department, string unit, string zone, string gender, string gradeCategory,string employeeGrade)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffProfileByGrade1.Database;
        ...
        public StaffProfileByGradeForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffProfileByGradeForm_Load(object sender, EventArgs e)
        {
            try
            {
