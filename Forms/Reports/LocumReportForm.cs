...
{
    public partial class LocumReportForm : Form
    {
        private IDAL dal;
        ...
        public LocumReportForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = LocumReport1.Database;
