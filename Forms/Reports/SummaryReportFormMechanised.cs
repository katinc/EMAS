...
{
    public partial class SummaryReportFormMechanised : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        public SummaryReportFormMechanised(bool pieChart, bool barChart, bool doughnut, int mechanisedCount, int totalStaff)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "MechanisedCount";
                paramDiscreteValue.Value = mechanisedCount;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = summaryReportMechanised.Database;
