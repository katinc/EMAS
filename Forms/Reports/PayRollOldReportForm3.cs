...
{
    public partial class PayRollOldReportForm3 : Form
    {
        private IDAL dal;
        ...
        public PayRollOldReportForm3(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised,string bank,string paymentacctype, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayRollRegisterOldFormat31.Database;
        ...
        private void PayRollOldReportForm3_Load(object sender, EventArgs e)
        {
            try
            {
