...
{
    public partial class ExcuseDutyReportFilter : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               string  sql = "select * from ViewExcuseDutyRequests ";
                DataTable dt;
                ...
                reportFilterDataRow["filterRequestType"] = "All";
                ...
                else
                {
                    ...
                    if (cboRequestType.SelectedItem != null)
                    {
                        dalHelper.CreateParameter("@RequestType", cboRequestType.SelectedItem, DbType.String);
                        reportFilterDataRow["filterRequestType"] = cboRequestType.SelectedItem;
                ...
                if (errorText != string.Empty)
                    MessageBox.Show(errorText);
                     ...
                     reportForm = new ExcuseDutyReport(dt,reportFilterDataTable);
                    reportForm.Show();
                }
        ...
        private void Clear()
        {
            try
            {
                ...
                cboRecommended.SelectedIndex = -1;
