...
{
    public partial class AppraisalReportForm : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        public AppraisalReportForm(string staffID, string appraisalPeriod, bool isDateFromChecked, bool isDateToChecked, 
            ...
            string zone)
        {
            ...
            Database mydatabase = AppraisalReport1.Database;
