...
{
    public partial class IncomeTaxReturnsReportForm : Form
    {
        private IDAL dal;
        ...
        public IncomeTaxReturnsReportForm(string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = incomeTaxReturns1.Database;
        ...
        public IncomeTaxReturnsReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void IncomeTaxReturnsReportForm_Load(object sender, EventArgs e)
        {
            try
            {
