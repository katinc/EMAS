...
{
    public partial class OtherAllowanceSelect : Form
    {
        ...
        private void OtherAllowanceSelect_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbOption.Text.Trim() == "Individual Employee")
                {
                    if (ValidateFields())
                    {
                        ...
                        else
                        {
                            ...
                            reportForm = new OtherAllowanceForm(staffIDtxt.Text.Trim(), monthComboBox.Text.Trim(), yearComboBox.Text.Trim(), cboMechanised.Text.Trim());
                            reportForm.Show();
                        }
                    }
                }
