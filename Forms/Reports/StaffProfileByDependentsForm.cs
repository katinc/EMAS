...
{
    public partial class StaffProfileByDependentsForm : Form
    {
        private IDAL dal;
        ...
        public StaffProfileByDependentsForm(bool isAsAtDateChecked, DateTime asAtDate, string staffID)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffProfileByDependents1.Database;
        ...
        public StaffProfileByDependentsForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffProfileByDependentsForm_Load(object sender, EventArgs e)
        {
            try
            {
