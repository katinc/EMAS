...
{
    public partial class OtherAllowanceForm : Form
    {
        private IDAL dal;
        ...
        public OtherAllowanceForm(string staffID,string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = OtherAllowances1.Database;
        ...
        private void OtherAllowanceForm_Load(object sender, EventArgs e)
        {
            try
            {
