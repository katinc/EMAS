...
{
    public partial class SSNITAllReturnsFormatForm : Form
    {
        private IDAL dal;
        ...
        public SSNITAllReturnsFormatForm(string month, string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = AllSSNITReturnsFormatReport1.Database;
        ...
        public SSNITAllReturnsFormatForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITAllReturnsFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
