...
{
    public partial class StaffListByZoneForm : Form
    {
        private IDAL dal;
        ...
        public StaffListByZoneForm(bool isAsAtDateChecked, DateTime asAtDate, string gender, string department, string unit, string zone, string gradeCategory, string grade, bool staffNoBy, bool nameBy, bool departmentBy)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffProfileByZone1.Database;
        ...
        private void StaffListByZoneForm_Load(object sender, EventArgs e)
        {
            try
            {
