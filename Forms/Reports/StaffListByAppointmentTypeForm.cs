...
{
    public partial class StaffListByAppointmentTypeForm : Form
    {
        private IDAL dal;
        ...
        public StaffListByAppointmentTypeForm(string department, string unit, string zone, string appointmentType, string gradeCategory, string grade, bool staffNoBy, bool nameBy, bool departmentBy)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "AppointmentType";
                paramDiscreteValue.Value = appointmentType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = StaffListByAppointmentReport1.Database;
        ...
        private void StaffListByAppointmentTypeForm_Load(object sender, EventArgs e)
        {
