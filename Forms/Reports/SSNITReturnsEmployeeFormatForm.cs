...
{
    public partial class SSNITReturnsEmployeeFormatForm : Form
    {
        private IDAL dal;
        ...
        public SSNITReturnsEmployeeFormatForm(string month,string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SSNITReturnsEmployeeFormat1.Database;
        ...
        public SSNITReturnsEmployeeFormatForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITReturnsEmployeeFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
