...
{
    public partial class PayrollCombineRegisterDetailReportForm : Form
    {
        ...
        public PayrollCombineRegisterDetailReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised,string bank, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayrollCombineRegisterDetailReport1.Database;
        ...
        public PayrollCombineRegisterDetailReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PayrollCombineRegisterDetailReportForm_Load(object sender, EventArgs e)
        {
            try
            {
