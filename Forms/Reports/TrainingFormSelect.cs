...
{
    public partial class TrainingFormSelect : Form
    {
        private IDAL dal;
        ...
        public TrainingFormSelect(string types)
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            this.reportType = types;
        }

        private void TrainingFormSelect_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void cmbOption_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (cmbOption.Text.ToLower() != "individual")
                {
                    ...
                    cboTrainingType.Visible = true;
                    

                    if (reportType == "TrainingNeeds")
                    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    reportForm = new TrainingReportForm(staffIDtxt.Text.Trim(), cboTrainingType.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                    reportForm.Show();
                }
                else
                {
                    reportForm = new TrainingNeeds(staffIDtxt.Text.Trim(), cboTrainingType.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                    reportForm.Show();
                }
        ...
        private void cboTransferType_DropDown(object sender, EventArgs e)
        {
            try
            {
                ...
                if (reportType == "TrainingNeeds")
                {
                    var trainingTypes = GlobalData._context.TrainingAllowanceTypes.Where(u => u.Active == true && u.Archived == false).ToList();
                ...
                {
                    var trainingTypes = GlobalData._context.TrainingTypes.Where(u => u.Active == true && u.Archived == false).ToList();
                    foreach (var item in trainingTypes)
                    {
                        cboTrainingType.Items.Add(item.Description);
                    }
