...
{
    public partial class LeaveReportSelect : Form
    {
        ...
        private void LeaveReportSelect_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cboLeaveType.Text.ToLower() == "study leave")
                {
                    reportForm = new StudyLeaveReportForm(txtStaffNo.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim(), cboRecommended.Text.Trim(), cboApproved.Text.Trim());
                    reportForm.Show();
                }
                else
                {
                    reportForm = new LeaveReportForm(txtStaffNo.Text.Trim(), cboLeaveType.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim(), cboRecommended.Text.Trim(), cboApproved.Text.Trim());
                    reportForm.Show();
                }
