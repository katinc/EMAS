...
{
    public partial class LeaveRoasterReportForm : Form
    {
        private IDAL dal;
        ...
        public LeaveRoasterReportForm(string staffID, string leaveType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = LeaveRoasterReport1.Database;
        ...
        private void LeaveRoasterReportForm_Load(object sender, EventArgs e)
        {
            try
            {
