...
{
    public partial class JoinersForm : Form
    {
        private IDAL dal;
        ...
        public JoinersForm(bool isDateFromChecked, DateTime dateFrom, bool isDateToChecked, DateTime dateTo, string gender)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = Joiners1.Database;
        ...
        private void JoinersForm_Load(object sender, EventArgs e)
        {
            try
            {
