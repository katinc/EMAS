...
{
    public partial class StaffListByJobSelect : Form
    {
        ...
        private void StaffListByJobSelect_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                staffNoRadioButton.Checked=true;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                reportForm = new StaffListByJobForm(asAtDatePicker.Checked, asAtDatePicker.Value, cboGender.Text, cboDepartment.Text, cboUnit.Text.Trim(), cboZone.Text.Trim(),cboJobTitle.Text,cboGradeCategory.Text,cboGrade.Text, staffNoRadioButton.Checked,nameRadioButton.Checked,departmentRadioButton.Checked);
                reportForm.Show();
            }
            catch (Exception ex)
            {
