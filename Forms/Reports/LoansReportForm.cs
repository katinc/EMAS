...
namespace eMAS.Forms.Reports
{
    public partial class LoansReportForm : Form
    {
        ...
        public LoansReportForm(string staffID,string loanType, bool startDateChecked,DateTime startDate)
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            paramField = new ParameterField();
            paramDiscreteValue = new ParameterDiscreteValue();
            paramField.Name = "StartDateChecked";
            paramDiscreteValue.Value = startDateChecked;
            paramField.CurrentValues.Add(paramDiscreteValue);
            paramFields.Add(paramField);
            ...
            Database mydatabase = loansReport1.Database;
