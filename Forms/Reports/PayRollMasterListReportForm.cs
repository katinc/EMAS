...
{
    public partial class PayRollMasterListReportForm : Form
    {
        ...
        public PayRollMasterListReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised,string bank, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayRollRegisterMasterList1.Database;
        ...
        public PayRollMasterListReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PayRollMasterListReportForm_Load(object sender, EventArgs e)
        {
            try
            {
