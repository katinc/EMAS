...
{
    public partial class PaySlipFormatReportForm : Form
    {
        private IDAL dal;
        ...
        public PaySlipFormatReportForm(string staffID, int paymentID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PaySlipFormatReport1.Database;
        ...
        public PaySlipFormatReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PaySlipFormatReportForm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void PaySlipFormatReportForm_Load_1(object sender, EventArgs e)
        {
