...
{
    public partial class SusuMonthlyContributionSelect : Form
    {
        ...
        public SusuMonthlyContributionSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void SusuMonthlyContributionSelect_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbOption.Text.Trim() == "Individual Employee")
                {
                    if (ValidateFields())
                    {
                        ...
                        else
                        {
                            ...
                            reportForm = new SusuMonthlyContrbutionForm(staffIDtxt.Text, monthComboBox.Text, yearComboBox.Text);
                            reportForm.Show();
                        }
                    }
                }
