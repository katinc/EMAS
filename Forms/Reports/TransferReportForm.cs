...
namespace eMAS.Forms.Reports
{
    public partial class TransferReportForm : Form
    {
        ...
        public TransferReportForm(string staffID, string separationType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = TransfersReport1.Database;
