...
namespace eMAS.Forms.Reports
{
    public partial class PayRollReportForm : Form
    {
        ...
        public PayRollReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayRollReport1.Database;
