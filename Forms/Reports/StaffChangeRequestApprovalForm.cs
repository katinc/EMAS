...
{
    public partial class StaffChangeRequestApprovalForm : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        public StaffChangeRequestApprovalForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string dataset)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangesApprovalReport1.Database;
