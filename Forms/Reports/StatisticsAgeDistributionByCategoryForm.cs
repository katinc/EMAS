...
{
    public partial class StatisticsAgeDistributionByCategoryForm : Form
    {
        private IDAL dal;
        ...
        public StatisticsAgeDistributionByCategoryForm(bool isAsAtDateChecked, DateTime asAtDate)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StatisticsAgeDistributionByCategory1.Database;
        ...
        public StatisticsAgeDistributionByCategoryForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StatisticsAgeDistributionByCategoryForm_Load(object sender, EventArgs e)
        {
            try
            {
