...
{
    public partial class StatisticsGenderDistributionByZoneForm : Form
    {
        private IDAL dal;
        ...
        public StatisticsGenderDistributionByZoneForm(bool isAsAtDateChecked, DateTime asAtDate)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StatisticsGenderDistributionByZone1.Database;
        ...
        public StatisticsGenderDistributionByZoneForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StatisticsGenderDistributionByZoneForm_Load(object sender, EventArgs e)
        {
            try
            {
