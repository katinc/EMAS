...
{
    public partial class StaffProfileReportForm : Form
    {
        private IDAL dal;
        ...
        public StaffProfileReportForm(bool isDateFromDOFAChecked, bool isDateToDOFAChecked, DateTime dateFromDOFA, DateTime dateToDOFA, bool isDateFromAssumptionChecked, bool isDateToAssumptionChecked, DateTime dateFromAssumption, DateTime dateToAssumption, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string employeeGrade, string zone, string mechanised, string leave, string gender, string probation, DateTime asAtDate, bool asAtDateChecked, string confirmed)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffProfile1.Database;
        ...
        private void StaffProfileReportForm_Load(object sender, EventArgs e)
        {
            try
            {
