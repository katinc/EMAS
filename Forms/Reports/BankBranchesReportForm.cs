...
{
    public partial class BankBranchesReportForm : Form
    {
        private IDAL dal;
        public BankBranchesReportForm()
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            Database mydatabase = BankBranches1.Database;
        ...
        private void BankBranchesReportForm_Load(object sender, EventArgs e)
        {
            try
            {
