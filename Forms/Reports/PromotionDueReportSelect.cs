...
{
    public partial class PromotionDueReportSelect : Form
    {
        private IDAL dal;
        ...
        public PromotionDueReportSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                reportForm = new PromotionDueReportForm(staffIDtxt.Text.Trim(),cboMechanised.Text.Trim(), datePickerAsAt.Checked, datePickerAsAt.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                reportForm.Show();
        ...
        private void PromotionDueReportSelect_Load(object sender, EventArgs e)
        {
            try
            {
                this.Text = GlobalData.Caption;
                datePickerAsAt.Value = DateTime.Today.Date;
                datePickerAsAt.Checked = false;
