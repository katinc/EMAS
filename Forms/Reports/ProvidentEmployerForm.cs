...
{
    public partial class ProvidentEmployerForm : Form
    {
        private IDAL dal;
        ...
        public ProvidentEmployerForm(string month, string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = ProvidentReturnsEmployer1.Database;
        ...
        private void ProvidentEmployerForm_Load(object sender, EventArgs e)
        {
            try
            {
