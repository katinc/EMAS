...
{
    public partial class WithholdingMonthlyContrbutionForm : Form
    {
        private IDAL dal;
        ...
        public WithholdingMonthlyContrbutionForm(string staffID,string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = WithholdingMonthlyContributionReport1.Database;
        ...
        public WithholdingMonthlyContrbutionForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void WithholdingMonthlyContrbutionForm_Load(object sender, EventArgs e)
        {
            try
            {
