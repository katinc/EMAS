...
{
    public partial class StaffChangeDOBForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeDOBForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangeDOBReport1.Database;
        ...
        private void StaffChangeDOBForm_Load(object sender, EventArgs e)
        {
            try
            {
