...
{
    public partial class StaffProfileByGenderForm : Form
    {
        private IDAL dal;
        ...
        public StaffProfileByGenderForm(bool isAsAtDateChecked, DateTime asAtDate, string gender)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffProfileByGender1.Database;
        ...
        public StaffProfileByGenderForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffProfileByGenderForm_Load(object sender, EventArgs e)
        {
            try
            {
