...
{
    public partial class StaffChangeEmploymentDateForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeEmploymentDateForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangeEmploymentDateReport1.Database;
        ...
        public StaffChangeEmploymentDateForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffChangeEmploymentDateForm_Load(object sender, EventArgs e)
        {
            try
            {
