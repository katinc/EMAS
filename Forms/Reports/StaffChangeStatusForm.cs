...
{
    public partial class StaffChangeStatusForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeStatusForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangeStatusReport1.Database;
        ...
        private void StaffChangeStatusForm_Load(object sender, EventArgs e)
        {
            try
            {
