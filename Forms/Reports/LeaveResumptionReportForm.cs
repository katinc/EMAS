...
{
    public partial class LeaveResumptionReportForm : Form
    {
        private IDAL dal;
        ...
        public LeaveResumptionReportForm(string staffID, string leaveType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = LeaveResumptionReport1.Database;
        ...
        public LeaveResumptionReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void LeaveResumptionReportForm_Load(object sender, EventArgs e)
        {
            try
            {
