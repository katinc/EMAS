...
{
    public partial class AppraisalSummaryReportForm : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        public AppraisalSummaryReportForm(string staffID, string appraisalPeriod, bool isDateFromChecked, bool isDateToChecked,
            DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade,
            string zone)
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            paramField = new ParameterField();
            paramDiscreteValue = new ParameterDiscreteValue();
            paramField.Name = "AppraisalPeriod";
            paramDiscreteValue.Value = appraisalPeriod;
            paramField.CurrentValues.Add(paramDiscreteValue);
            paramFields.Add(paramField);
            ...
            Database mydatabase = AppraisalSummaryReport1.Database;
        ...
        private void AppraisalSummaryReportForm_Load(object sender, EventArgs e)
        {
