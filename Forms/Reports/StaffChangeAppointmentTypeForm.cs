...
{
    public partial class StaffChangeAppointmentTypeForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeAppointmentTypeForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangeAppointmentTypeReport1.Database;
        ...
        public StaffChangeAppointmentTypeForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffChangeAppointmentTypeForm_Load(object sender, EventArgs e)
        {
            try
            {
