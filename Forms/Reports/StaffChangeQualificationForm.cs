...
{
    public partial class StaffChangeQualificationForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeQualificationForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffQualificationChangeReport1.Database;
