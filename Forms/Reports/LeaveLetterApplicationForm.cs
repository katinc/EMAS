...
{
    public partial class LeaveLetterApplicationForm : Form
    {
        private IDAL dal;
        ...
        private DataTable StaffPersonalInfoView;
        private ApplicationContext context;


        public LeaveLetterApplicationForm(string staffID, string type, DateTime startDate, DateTime endDate, decimal numberOfDays)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = LeaveLetter1.Database;
        ...
        public LeaveLetterApplicationForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void LeaveLetterApplicationForm_Load(object sender, EventArgs e)
        {
            try
            {
