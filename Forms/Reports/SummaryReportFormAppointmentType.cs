...
{
    public partial class SummaryReportFormAppointmentType : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        public SummaryReportFormAppointmentType(bool pieChart, bool barChart, bool doughnut, int appointmentTypeCount, int totalStaff)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "AppointmentTypeCount";
                paramDiscreteValue.Value = appointmentTypeCount;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = SummaryReportAppointmentType1.Database;
