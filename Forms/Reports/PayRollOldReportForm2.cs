...
{
    public partial class PayRollOldReportForm2 : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        private PleaseWait frm;

        
        public PayRollOldReportForm2(string staffID,string  month, string  year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised,string bank,string paymentacctype,PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "PaymentAccType";
                paramDiscreteValue.Value = paymentacctype;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = PayRollRegisterOldFormat21.Database;
        ...
        private void PayRollOldReportForm2_Load(object sender, EventArgs e)
        {
            try
            {
