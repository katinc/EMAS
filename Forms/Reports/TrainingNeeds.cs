...
{
    public partial class TrainingNeeds : Form
    {
        private IDAL dal;
        private ParameterFields paramFields;
        private ParameterField paramField;
        private ParameterDiscreteValue paramDiscreteValue;
        private TrainingNeedsReport tnr;
        public TrainingNeeds(string staffID, string trainingType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "AllowanceType";
                paramDiscreteValue.Value = trainingType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = TrainingNeedsReport1.Database;
        ...
        private void TrainingNeeds_Load(object sender, EventArgs e)
        {
