...
{
    public partial class PayrollSummarySalary : Form
    {
        ...
        public PayrollSummarySalary(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayrollSummarySalaryReport1.Database;
        ...
        private void PayrollSummarySalary_Load(object sender, EventArgs e)
        {
            try
            {
