...
{
    public partial class VehicleReportSearch : Form
    {
        private IDAL dal;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (reportForm != null && !reportForm.IsDisposed)
                {
                    ...
                    reportForm = new VehicleReportForm(staffIDtxt.Text.Trim(), cboVehicleType.Text.Trim(), cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                    reportForm.Show();
        ...
        private void cboVehicleType_DropDown(object sender, EventArgs e)
        {
            try
            {
                ...
                var vehicles = GlobalData._context.VehicleTypes.Where(u=>u.Active);
