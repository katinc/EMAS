...
{
    public partial class StaffListByQualificationForm : Form
    {
        private IDAL dal;
        ...
        public StaffListByQualificationForm(string qualification)
        {
            try
            {
                InitializeComponent();
                ...
                paramField.Name = "Qualification";
                paramDiscreteValue.Value = qualification;
                ...
                Database mydatabase = StaffProfileByQualification1.Database;
        ...
        public StaffListByQualificationForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffListByQualificationForm_Load(object sender, EventArgs e)
        {
            try
            {
