...
{
    public partial class OtherDeductionsSelect : Form
    {
        ...
        private void OtherDeductionsSelect_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbOption.Text.Trim() == "Individual Employee")
                {
                    if (ValidateFields())
                    {
                        ...
                        else
                        {
                            ...
                            reportForm = new OtherDeductionsReportForm(staffIDtxt.Text.Trim(), monthComboBox.Text.Trim(), yearComboBox.Text.Trim(), cboMechanised.Text.Trim());
                            reportForm.Show();
                        }
                    }
                }
