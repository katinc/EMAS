...
{
    public partial class SSNITPaymentVoucherForm : Form
    {
        private IDAL dal;
        ...
        public SSNITPaymentVoucherForm(string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SSNITPaymentVoucherReport1.Database;
        ...
        public SSNITPaymentVoucherForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITPaymentVoucherForm_Load(object sender, EventArgs e)
        {
            try
            {
