...
{
    public partial class SSNITAllReturnsForm : Form
    {
        private IDAL dal;
        ...
        public SSNITAllReturnsForm(string month, string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = AllSSNITReturnsReport1.Database;
        ...
        private void SSNITAllReturnsForm_Load(object sender, EventArgs e)
        {
            try
            {
