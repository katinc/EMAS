...
{
    public partial class PayRollSummaryByUnitReportForm : Form
    {
        ...
        public PayRollSummaryByUnitReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayrollSummaryByUnit1.Database;
        ...
        public PayRollSummaryByUnitReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PayRollSummaryByUnitReportForm_Load(object sender, EventArgs e)
        {
            try
            {
