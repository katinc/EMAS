...
namespace eMAS.Forms.Reports
{
    ...
    public partial class ExternalTrainingReportForm : Form
    {
        private reportCompanyInfoTableAdapter companyAdapta;

        public ExternalTrainingReportForm(DataTable reportExcuseDutyRequestsDataTable, eMAS.Forms.OtherDataSets.HR2Dataset.reportFilterDataTable reportFilterDataTable)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                dt.TableName = "reportExternalTraining";
                ...
                ExternalTrainingReport report = new ExternalTrainingReport();
