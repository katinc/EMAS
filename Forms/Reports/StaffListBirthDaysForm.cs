...
{
    public partial class StaffListBirthDaysForm : Form
    {
        private IDAL dal;
        ...
        public StaffListBirthDaysForm(bool isAsAtDateChecked, DateTime asAtDate, decimal ageFrom, decimal ageTo, DateTime monthselect)
        {
            try
            {
                InitializeComponent();
                ...
                paramDiscreteValue.Value = isAsAtDateChecked ? asAtDate : monthselect;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = StaffBirthDayList1.Database;
        ...
        private void StaffListBirthDaysForm_Load(object sender, EventArgs e)
        {
            try
            {
