...
{
    public partial class OtherAllowanceDetailForm : Form
    {
        private IDAL dal;
        ...
        public OtherAllowanceDetailForm(string staffID,string month,string year,string allowanceType,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                paramDiscreteValue.Value = allowanceType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = OtherAllowanceDetail1.Database;
        ...
        public OtherAllowanceDetailForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void OtherAllowanceDetailForm_Load(object sender, EventArgs e)
        {
            try
            {
