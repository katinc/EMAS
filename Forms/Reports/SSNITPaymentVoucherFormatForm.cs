...
{
    public partial class SSNITPaymentVoucherFormatForm : Form
    {
        private IDAL dal;
        ...
        public SSNITPaymentVoucherFormatForm(string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SSNITPaymentVoucherFormatReport1.Database;
        ...
        public SSNITPaymentVoucherFormatForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITPaymentVoucherFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
