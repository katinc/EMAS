...
{
    public partial class OtherDeductionDetailForm : Form
    {
        private IDAL dal;
        ...
        public OtherDeductionDetailForm(string staffID,string month,string year,string deductionType,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "DeductionType";
                paramDiscreteValue.Value = deductionType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = OtherDeductionDetail1.Database;
        ...
        public OtherDeductionDetailForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void OtherDeductionDetailForm_Load(object sender, EventArgs e)
        {
            try
            {
