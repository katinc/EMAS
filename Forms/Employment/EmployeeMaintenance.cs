    ...
    public partial class EmployeeMaintenance : Form
    {
        ...
        public void QuickSearchView(string search)
        {
            try
            {
                ...
                btnSave.Enabled = getPermissions.CanEdit;
        ...
        private void viewButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                searchForm.btnRemove.Enabled = getPermissions.CanDelete;
                searchForm.Show();
                searchForm.Focus();
        ...
        {         
            try
            {
                ...
                //getting and assigning permissions
                ...
                btnQuickSearch.Enabled = getPermissions.CanView;
                btnRemoveEmployee.Enabled = getPermissions.CanDelete;
            ...
            try
            {
                    ...
                    )
                {
                    ...
                    if (editMode )
                    {
                        ...
                        query += "TransferredOut=@TransferredOut,IsProvidentFund=@IsProvidentFund,QualificationID=@QualificationID,TransferredIn=@TransferredIn,PaymentAccType=@PaymentAccType,UserType=@UserType, GPSAddress=@GPSAddress, ConversionDate=@ConversionDate, UpgradeDate=@UpgradeDate, VehicleNumber=@VehicleNumber, VehicleDescription=@VehicleDescription, VehicleType=@VehicleType " +
                            "Where ID = @ID";
                    ...
                    else
                    {
                        ...
                        query += "RaceID,Tribe,Overseer,SupervisorCode,StatusID,ZoneID,DirectorateID,InZoneDate,TransferredOut,IsProvidentFund,QualificationID,TransferredIn,PaymentAccType,UserType, GPSAddress, ConversionDate, UpgradeDate, VehicleNumber, VehicleDescription, VehicleType)";
        ...
        void getLeaveEntitlements()
        {
            try
            {
                ...
                if (dtAnnualLeave == null || dtAnnualLeave.Rows.Count < 1)
                {
                    ...
                    //SqlDataAdapter adapta = new SqlDataAdapter("select * from AnnualLeaveEntitlement where active='true' and archived='false'", new SqlConnection(connectionString));
        ...
        private void gradeComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            DataTable tbl = dalHelper.ExecuteReader("Select e.*,s1.description as start_desc,s1.numeric_part as start_numeric_part,s2.numeric_part as end_numeric_part,s2.description as end_desc " +
                "from EmployeeGradeView e left outer join ViewSortedStepsAlphaNumeric s1 on  s1.id=e.startstep left outer join ViewSortedStepsAlphaNumeric s2 on s2.id=e.endstep Where e.GradeCategory = @GradeCategory " +
                "and e.Description=@Description  order by e.Description asc");
            cboBand.Items.Clear();
            cboStep.Items.Clear();
