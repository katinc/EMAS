...
namespace eMAS.All_UIs.Staff_Information_FORMS
{
	...
	*/
	...
	#region Form Event Handlers:
		...
		public virtual void CaptureForm_Load(object sender, EventArgs e)
		{
			Init();
	...
	#region EventHandler Members:
        ...
        {
            set { Prompt.Visible = value; }
        }

        public bool StatusLineVisible
        {
            set { StatusLine.Visible = value; }
        }

        public bool StatusTextVisible
        {
            set { StatusText.Visible = value; }
        }
