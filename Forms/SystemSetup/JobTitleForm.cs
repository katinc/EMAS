        ...
        private void GetData()
        {
            try
            {
                ...
                {*/
                    ...
                    var dtJobTitles= dalHelper.ExecuteReader("select * from ViewStaffJobTitle where  Archived=@Archived");

                    foreach (DataRow dRow in dtJobTitles.Rows)
                    {
                        var jobTitle = new JobTitle();
                        jobTitle.ID =int.Parse(dRow["id"].ToString());
                        jobTitle.Active =(dRow["Active"]!=null)?bool.Parse(dRow["Active"].ToString()):true;
                        jobTitle.Description =(dRow["Description"]!=null)? dRow["Description"].ToString():null;
                        jobTitle.Code =(dRow["Code"]!=null)? dRow["Code"].ToString():null;
