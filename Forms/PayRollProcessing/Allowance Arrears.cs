...
{
    public partial class Allowance_Arrears : Form
    {
        ...
        private void Allowance_Arrears_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void UpdateArrearsInfo()
        {
            try
            {
                ...
                arrearsInfo.PreviousSalary = 0;
                arrearsInfo.CurrentSalary = numericUpDownPreviousSalary.Value;
        ...
        public void GetAllowances()
        {
            try
            {
                ...
                cboType.DataSource = this.allowanceTypes;
        ...
        public Arrears Arrear
        {
            ...
            {
                Clear();
                label5.Text = "Edit Allowance Arrears";
                editMode = true;
                arrearsID = value.ID;
                searchGrid.Visible = false;
                groupBox1.Enabled = true;
                ...
                numericUpDownPreviousSalary.Value = value.CurrentSalary;
