    ...
    public partial class SalaryInfoNew : Form
    {
        ...
        private void SalaryInfoNew_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                var getPermissions = GlobalData._context.UserAccessLevelsViews.FirstOrDefault(u => u.AccessLevel3Control == GlobalData.ItemControl && u.RoleName == GlobalData.Role);
                if (getPermissions != null)
                {
                    ...
                    savebtn.Enabled = CanAdd || CanEdit;
                }
                ...
                if (searchGrid.CurrentRow != null)
                {
                    foreach (Employee employee in employees)
                    {
                        if (employee.StaffID.Trim() == searchGrid.CurrentRow.Cells["gridStaffNo"].Value.ToString().Trim())
                        {
                            ...
                            //cmbSalaryPaymentAccount_DropDown(this, EventArgs.Empty);
                            ...
                            if (salaryInfos.Count > 0)
                            {
                                ...
                                foreach(StaffSalaryHistory salaryInfo in salaryInfos)
                                {
                                    ...
                                    if (salaryInfo.EndDate == null)
                                    {
                                        ...
                                        basicSalary = salaryInfo.MonthlyBasicSalary;
                                    }
                                    else
                                    {
                                        endDate.Checked = true;
                                        //DateTime end_date = salaryInfo.StartDate;
                                        endDate.Value = Convert.ToDateTime(salaryInfo.EndDate);
                                    ...
                                    //cmbSalaryPaymentAccount.SelectedItem = salaryInfo.salaryPaymentAccount.AccountName;
                                   // break;
                                }
                            }
                            else
        ...
        private void Clear()
        {
            ...
            {
                ClearStaffInfo();
                gradeCategoryComboBox.DataSource = null;
                gradeCategoryComboBox.Text = string.Empty;
                gradeComboBox.DataSource = null;
                ...
                stepComboBox.DataSource = null;
                stepComboBox.Text = string.Empty;
                bandComboBox.DataSource = null;
               ...
               // cmbSalaryPaymentAccount.Items.Clear();
            }
            catch(Exception ex)
            {
                Logger.LogError(ex);
            ...
            try
            {
                if (ValidateFields())
                {
                    ...
                    if (editMode)
                    {
                        ...
                        //added
                        employee.PaymentAccType = paymentacctype.Text;
                        //end addition
        ...
        void gradeCategoryComboBox_DropDown(object sender, EventArgs e)
        {
            try
            {
                ...
                gradeCategoryComboBox.DataSource = gradeCategories;
                gradeCategoryComboBox.DisplayMember = "Description";
                gradeCategoryComboBox.ValueMember = "ID";
        ...
        private void gradeCategoryComboBox_SelectionChangeCommitted(object sender, EventArgs e)
        {
            try
            {
                ...
                query.Criteria.Add(new Criterion()
                {
                    ...
                    CriterionOperator = CriterionOperator.EqualTo,
                    Value = gradeCategoryComboBox.Text,
                    CriteriaOperator = CriteriaOperator.And
                });
                ...
                //gradeComboBox.DisplayMember = "Description";
        ...
        private void stepComboBox_DropDown(object sender, EventArgs e)
        {
            try
            {
                ...
                stepComboBox.DataSource = steps;
                stepComboBox.DisplayMember = "Description";
                stepComboBox.ValueMember = "ID";
            }
            catch (Exception ex)
            {
                string err = ex.Message;
        ...
        private void bandComboBox_DropDown(object sender, EventArgs e)
        {
            try
            {
                ...
                //bandComboBox.DataSource = bands;
                //bandComboBox.DisplayMember = "Description";
                //bandComboBox.ValueMember = "ID";
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
        ...
        private void departmentComboBox_SelectionChangeCommitted(object sender, EventArgs e)
        {
            try
            {
                ...
                //unitComboBox.DisplayMember = "Description";
