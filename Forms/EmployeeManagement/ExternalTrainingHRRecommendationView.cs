...
{
    public partial class ExternalTrainingHRRecommendationView : Form
    {
        private IDAL dal;
        ...
        public ExternalTrainingHRRecommendationView()
        {
            InitializeComponent();
            this.dal = new DAL();
            this.employeeGrades = new List<EmployeeGrade>();
        ...
        private void removeButton_Click(object sender, EventArgs e)
        {
            try
            {
                if (gridViewInfo.CurrentRow != null)
                {
                    ...
                    ExternalTrainingHRRecommendation recommendationForm = new ExternalTrainingHRRecommendation(externalTraining, this);
                    recommendationForm.ShowDialog(this);
                }
                else
