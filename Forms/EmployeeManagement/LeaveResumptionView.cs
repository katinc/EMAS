...
{
    public partial class LeaveResumptionView : Form
    {
        private IDAL dal;
        private Leave leave;
        private IList<Leave> leaves;
        private IList<Leave> foundLeaves;
        private LeaveResumptionForm leaveResumptionForm;
        ...
        public LeaveResumptionView(LeaveResumptionForm leaveResumptionForm)
        {
            try
            {
                InitializeComponent();
                this.dal = new DAL();
                this.leaveResumptionForm = leaveResumptionForm;
        ...
        public LeaveResumptionView()
        {
            try
            {
                InitializeComponent();
                this.dal = new DAL();
                this.leaveResumptionForm = new LeaveResumptionForm();
                this.employee = new Employee();
                this.leave = new Leave();
                this.employeeGrade = new EmployeeGrade();
                this.gradeCategory = new GradeCategory();
        ...
        void grid_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                {
                    if (!leaveResumptionForm.CanEdit)
                    {
                    ...
                    if (grid.CurrentRow.Cells["gridResumedDate"].Value != null)
                    {
                        leave.ResumedDate = DateTime.Parse(grid.CurrentRow.Cells["gridResumedDate"].Value.ToString());
                    }
                    leave.Resumed = bool.Parse(grid.CurrentRow.Cells["gridResumed"].Value.ToString());
                    leaveResumptionForm.EditLeave(leave);
        ...
        private void PopulateView(IList<Leave> leaves)
        {
            try
            {
                ...
                foreach (Leave leave in leaves)
                {
                    ...
                    grid.Rows[ctr].Cells["gridResumed"].Value = leave.Resumed;
                    grid.Rows[ctr].Cells["gridResumedDate"].Value = leave.ResumedDate;
        ...
        private void LeaveResumptionView_Load(object sender, EventArgs e)
        {
            try
            {
