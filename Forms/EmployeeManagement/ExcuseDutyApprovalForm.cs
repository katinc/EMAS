...
{
    public partial class ExcuseDutyApprovalForm : Form
    {
            ...
            try
            {
               ...
               /* }*/
                    if (cboApproved.Text != string.Empty)
                    {
                        ...
                        dalHelper.CreateParameter("@Approved", cboApproved.Text , DbType.Boolean);
                    }
                ...
                sql = "select top 50 * from ViewExcuseDutyRequests " + sql + " order by id desc";
        ...
        private void btnApprove_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (grid.SelectedRows.Count > 0 && MessageBox.Show(this, "Do You Really Want To Approve The Selected Records?", "Confirm!", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    var excuseDutyRequest = excuseDutyMapper.getById(Convert.ToInt32(grid.SelectedRows[0].Cells["gridID"].Value));
                    ExcuseDutyApprovalRemark ApprovalRemarks = new ExcuseDutyApprovalRemark(this, excuseDutyRequest);

                    ApprovalRemarks.ShowDialog(this);
        ...
        private void ExcuseDutyApprovalForm_Load(object sender, EventArgs e)
        {
