...
{
    public partial class GeneralReversalIncrementView : Form
    {
        private IDAL dal;
        private GeneralReversalIncrementForm generalReversalIncrementForm;
        ...
        public GeneralReversalIncrementView(GeneralReversalIncrementForm generalReversalIncrementForm)
        {
            try
            {
                InitializeComponent();
                this.generalReversalIncrementForm = generalReversalIncrementForm;
        ...
        public GeneralReversalIncrementView()
        {
            try
            {
                InitializeComponent();
                this.generalReversalIncrementForm = new GeneralReversalIncrementForm();
                this.employee = new Employee();
                this.increment = new Increment();
                this.employeeGrade = new EmployeeGrade();
                this.gradeCategory = new GradeCategory();
        ...
        void grid_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (grid.CurrentRow != null && generalReversalIncrementForm.CanEdit)
                {
                    if (grid.CurrentRow != null)
                    {
                        generalReversalIncrementForm.EditGeneralReversalIncrement(grid.CurrentRow);
                        this.Close();
                    }
                }
                else if (!generalReversalIncrementForm.CanEdit)
                {
        ...
        private void GeneralReversalIncrementView_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void datePickerIncrementDate_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (Increment increment in increments)
                {
                    if (increment.IncrementDate.Value.Date == datePickerIncrementDate.Value.Date)
                    {
