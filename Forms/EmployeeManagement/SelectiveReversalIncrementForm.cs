...
{
    public partial class SelectiveReversalIncrementForm : Form
    {
        ...
        public SelectiveReversalIncrementForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SelectiveReversalIncrementForm_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void EditSelectiveReversalIncrement(DataGridViewRow row)
        {
            try
            {
                Clear();
            ...
            try
            {
                if (ValidateFields())
                {
                    ...
                    if (editMode)
                    {
                        ...
                        GlobalData.ProcessEdit(OldValues, controls, this, incrementID, staffIDtxt.Text);
                    }
                    else
                    {
                        if (incrementDatePicker.Value.Date <= DateTime.Today.Date)
        ...
        private void UpdateIncrementsEntity()
        {
            try
            {
                ...
                increment.Employee.StaffID = staffIDtxt.Text;
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            try
            {
                SelectiveReversalIncrementView form = new SelectiveReversalIncrementView(this);
