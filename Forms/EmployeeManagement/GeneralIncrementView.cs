...
{
    public partial class GeneralIncrementView : Form
    {
        private IDAL dal;
        private GeneralIncrementForm generalIncrementForm;
        ...
        public GeneralIncrementView(GeneralIncrementForm generalIncrementForm)
        {
            try
            {
                InitializeComponent();
                this.generalIncrementForm = generalIncrementForm;
        ...
        public GeneralIncrementView()
        {
            try
            {
                InitializeComponent();
                this.generalIncrementForm = new GeneralIncrementForm();
                this.employee = new Employee();
                this.increment = new Increment();
                this.employeeGrade = new EmployeeGrade();
                this.gradeCategory = new GradeCategory();
        ...
        void grid_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                if (grid.CurrentRow != null && generalIncrementForm.CanEdit)
                {
                    if (grid.CurrentRow != null)
                    {
                        generalIncrementForm.EditGeneralIncrement(grid.CurrentRow);
                        this.Close();
                    }
                }
                else if (!generalIncrementForm.CanEdit)
                {
        ...
        private void GeneralIncrementView_Load(object sender, EventArgs e)
        {
            try
            {
