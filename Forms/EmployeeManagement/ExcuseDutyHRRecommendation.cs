...
{
    public partial class ExcuseDutyHRRecommendation : Form
    {
        private ExcuseDutyRequest excuseDutyRequest;
        ExcuseDutyHRRecommendationRemark excuseDutyRecommendRemakForm;
        ...
        public ExcuseDutyHRRecommendation()
        {
            InitializeComponent();
            excuseDutyMapper = new ExcuseDutyRequestDataMapper();
            lstexcuseDutyRequests = new List<ExcuseDutyRequestType>();
            excuseDutyRequestTypeMapper = new ExcuseDutyRequestTypeDataMapper();
            units = new List<Unit>();
        ...
        private void GetData()
        {
            ...
            try
            {
                ...
                if (cboRecommended.Text != string.Empty)
                {
                    ...
                    dalHelper.CreateParameter("@Recommended", cboRecommended.Text, DbType.Boolean);
                }
                if (cboApproved.Text != string.Empty)
                {
                    sql += " Approved = @Approved  and (HRRecommended is null or HRRecommended='false') and";
                ...
                sql = "select * from ViewExcuseDutyRequests " + sql;
        ...
        private void btnRecommend_Click(object sender, EventArgs e)
        {
            ...
            {
                excuseDutyRequest = excuseDutyMapper.getById(Convert.ToInt32(grid.SelectedRows[0].Cells["gridID"].Value));
                excuseDutyRecommendRemakForm = new ExcuseDutyHRRecommendationRemark();
                excuseDutyRecommendRemakForm.setExcuseDutyRequest(excuseDutyRequest, this);
                excuseDutyRecommendRemakForm.parentGrid = grid;
        ...
        private void ExcuseDutyHRRecommendation_Load(object sender, EventArgs e)
        {
