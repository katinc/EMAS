        ...
        private void GetData()
        {
            try
            {
                ...
                if (found == true)
                {
                    query.Criteria.Add(new Criterion()
                    {
                        Property = "StaffPersonalInfoView.UserID",
                        CriterionOperator = CriterionOperator.EqualTo,
                ...
                //    query.Criteria.Add(new Criterion()
                //    {
                //        Property = "StaffPersonalInfoView.ProbationEndDate",
                ...
                if (txtSurname.Text.Trim() != string.Empty)
                {
                    query.Criteria.Add(new Criterion()
                    {
                        Property = "StaffPersonalInfoView.Surname",
                ...
                if (txtFirstName.Text.Trim() != string.Empty)
                {
                    query.Criteria.Add(new Criterion()
                    {
                        Property = "StaffPersonalInfoView.Firstname",
                        CriterionOperator = CriterionOperator.Like,
                ...
                if (cboApprove.Text.Trim() != string.Empty && cboApprove.Text.ToLower().Trim() != "all")
                {
                    query.Criteria.Add(new Criterion()
                    {
                        Property = "StaffPersonalInfoView.Probation",
                        CriterionOperator = CriterionOperator.EqualTo ,
                        Value = approved,
                        CriteriaOperator = CriteriaOperator.And
                    });
                ...
                if (ValidateFields())
                {
                    ...
                    foreach (DataGridViewRow row in grid.Rows)
                    {
                        if (grid.Rows[ctr].Cells["gridID"].Value != null && grid.Rows[ctr].Cells["gridSelect"].Value !=null)
                        {
                            ...
                            employee.CurrentConfirmationDate = DateTime.Now;//Convert.ToDateTime(grid.Rows[ctr].Cells["gridConfirmationDate"].Value).Date;
