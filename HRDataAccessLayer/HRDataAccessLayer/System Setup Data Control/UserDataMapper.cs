    ...
    public class UserDataMapper
    {
        ...
        public void Save(object item)
        {
            try
            {
                ...
                dal.CreateParameter("@UserRole", user.UserRole, DbType.String);
                ...
                dal.ExecuteNonQuery("Insert Into Users (FingerPrint,Password,SecurityAnswer,SecurityQuestion,UserCategoryID,UserName,BarCode,EmpID,Name,StaffID,CreateUserID,UpdateUserID,UserRole) Values(@FingerPrint,@Password,@SecurityAnswer,@SecurityQuestion,@UserCategoryID,@UserName,@BarCode,@EmpID,@Name,@StaffID,@CreateUserID,@UpdateUserID,@UserRole)");
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
