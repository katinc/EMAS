    ...
    public class PayRollAttendanceDataMapper
    {
        ...
        public void Save(object item)
        {
            try
            {
                ...
                //dal.CreateParameter("@PaymentAcctype", attendance.PaymentAccType, DbType.String);

                //dal.ExecuteNonQuery("INSERT INTO StaffSalaryPayments(PaymentID,Title,Name,StaffID,StaffCode,DaysOfAttendance,Month,Year,BasicSalary,ActualBasicSalary,SSNITEmployee,SSNITEmployer,ProvidentFundEmployee,ProvidentFundEmployer,SSNITFirstTier,SecondTier,IncomeTax,NetAfterTax,NetSalary,MedicalClaims,Arrears,TakeHome,Loan,InitialLoan,TotalAllowance,TotalDeduction,TotalOverTime,PaymentMode,Department,Unit,Zone,JobTitle,GradeCategory,Grade,Status,GradeLevel,Mechanised, IsProvidentFund, SSNIT,SSNITNo,UserID,UserName,SSNITEmployeeRate,SSNITEmployerRate,SSNITFirstTierRate,SecondTierRate,ProvidentFundEmployeeRate,ProvidentFundEmployerRate,GrossSalary,TaxableIncome,IsExemptFromSecondTier,IsSusuPlusContribution,IsWithholdingTax,IsWithholdingTaxFixedAmount,IsWithholdingTaxRate,SusuPlusContribution,WithholdingAmount,WithholdingFixedTaxAmount,WithholdingTaxCalculateOn,WithholdingTaxRate,Bank,BankBranch,BankAddress,AccountNumber,AccountType,AccountName,GrandTotalAllowance,GrandTotalDeduction,Email,MobileNumber,IsExemptAllowance,IsExemptDeduction,TotalOverTimeHours,PublicHolidayOverTime,PublicHolidayOverTimeHours,DailyOverTime,DailyOverTimeHours,HoursWorked,WeekendOverTime,WeekendOverTimeHours,SaturdayOverTime,SaturdayOverTimeHours,SundayOverTime,SundayOverTimeHours,NightOverTime,NightOverTimeHours,AnnualLeaveBalance,AnnualLeave,TotalOverTimeTax,TotalBonus,TotalBonusTax,SalaryAdvance,WageAdvance,TotalTax,Step,NonAllowanceTax,AllowanceTax,Overseer,UpfrontRelief,AnnualLeaveMonthly,AnnualLeaveBalanceMonthly,ExemptFirstTierRate,TotalCost,TotalPayable,PaymentAccType) VALUES(@PaymentID,@Title,@Name,@StaffID,@StaffCode,@DaysOfAttendance,@Month,@Year,@BasicSalary,@ActualBasicSalary,@SSNITEmployee,@SSNITEmployer,@ProvidentFundEmployee,@ProvidentFundEmployer,@SSNITFirstTier,@SecondTier,@IncomeTax,@NetAfterTax,@NetSalary,@MedicalClaims,@Arrears,@TakeHome,@Loan,@InitialLoan,@TotalAllowance,@TotalDeduction,@TotalOverTime,@PaymentMode,@Department,@Unit,@Zone,@JobTitle,@GradeCategory,@Grade,@Status,@GradeLevel,@Mechanised,@IsProvidentFund,@SSNIT,@SSNITNo,@UserID,@UserName,@SSNITEmployeeRate,@SSNITEmployerRate,@SSNITFirstTierRate,@SecondTierRate,@ProvidentFundEmployeeRate,@ProvidentFundEmployerRate,@GrossSalary,@TaxableIncome,@IsExemptFromSecondTier,@IsSusuPlusContribution,@IsWithholdingTax,@IsWithholdingTaxFixedAmount,@IsWithholdingTaxRate,@SusuPlusContribution,@WithholdingAmount,@WithholdingFixedTaxAmount,@WithholdingTaxCalculateOn,@WithholdingTaxRate,@Bank,@BankBranch,@BankAddress,@AccountNumber,@AccountType,@AccountName,@GrandTotalAllowance,@GrandTotalDeduction,@Email,@MobileNumber,@IsExemptAllowance,@IsExemptDeduction,@TotalOverTimeHours,@PublicHolidayOverTime,@PublicHolidayOverTimeHours,@DailyOverTime,@DailyOverTimeHours,@HoursWorked,@WeekendOverTime,@WeekendOverTimeHours,@SaturdayOverTime,@SaturdayOverTimeHours,@SundayOverTime,@SundayOverTimeHours,@NightOverTime,@NightOverTimeHours,@AnnualLeaveBalance,@AnnualLeave,@TotalOverTimeTax,@TotalBonus,@TotalBonusTax,@SalaryAdvance,@WageAdvance,@TotalTax,@Step,@NonAllowanceTax,@AllowanceTax,@Overseer,@UpfrontRelief,@AnnualLeaveMonthly,@AnnualLeaveBalanceMonthly,@ExemptFirstTierRate,@TotalCost,@TotalPayable,@PaymentAccType)");
                dal.ExecuteNonQuery("INSERT INTO StaffSalaryPayments(PaymentID,Title,Name,StaffID,StaffCode,DaysOfAttendance,Month,Year,BasicSalary,ActualBasicSalary,SSNITEmployee," +
                    "SSNITEmployer,ProvidentFundEmployee,ProvidentFundEmployer,SSNITFirstTier,SecondTier,IncomeTax,NetAfterTax,NetSalary,MedicalClaims,Arrears,TakeHome,Loan,InitialLoan," +
                    "TotalAllowance,TotalDeduction,TotalOverTime,PaymentMode,Department,Unit,Zone,JobTitle,GradeCategory,Grade,Status,GradeLevel,Mechanised, IsProvidentFund, SSNIT,SSNITNo," +
                    "UserID,UserName,SSNITEmployeeRate,SSNITEmployerRate,SSNITFirstTierRate,SecondTierRate,ProvidentFundEmployeeRate,ProvidentFundEmployerRate,GrossSalary,TaxableIncome," +
                    "IsExemptFromSecondTier,IsSusuPlusContribution,IsWithholdingTax,IsWithholdingTaxFixedAmount,IsWithholdingTaxRate,SusuPlusContribution,WithholdingAmount,WithholdingFixedTaxAmount," +
                    "WithholdingTaxCalculateOn,WithholdingTaxRate,Bank,BankBranch,BankAddress,AccountNumber,AccountType,AccountName,GrandTotalAllowance,GrandTotalDeduction,Email,MobileNumber," +
                    "IsExemptAllowance,IsExemptDeduction,TotalOverTimeHours,PublicHolidayOverTime,PublicHolidayOverTimeHours,DailyOverTime,DailyOverTimeHours,HoursWorked,WeekendOverTime," +
                    "WeekendOverTimeHours,SaturdayOverTime,SaturdayOverTimeHours,SundayOverTime,SundayOverTimeHours,NightOverTime,NightOverTimeHours,AnnualLeaveBalance,AnnualLeave,TotalOverTimeTax," +
                    "TotalBonus,TotalBonusTax,SalaryAdvance,WageAdvance,TotalTax,Step,NonAllowanceTax,AllowanceTax,Overseer,UpfrontRelief,AnnualLeaveMonthly,AnnualLeaveBalanceMonthly," +
                    "ExemptFirstTierRate,TotalCost,TotalPayable) " +
                    "" +
                    "VALUES(@PaymentID,@Title,@Name,@StaffID,@StaffCode,@DaysOfAttendance,@Month,@Year,@BasicSalary,@ActualBasicSalary," +
                    "@SSNITEmployee,@SSNITEmployer,@ProvidentFundEmployee,@ProvidentFundEmployer,@SSNITFirstTier,@SecondTier,@IncomeTax,@NetAfterTax,@NetSalary,@MedicalClaims,@Arrears,@TakeHome,@Loan," +
                    "@InitialLoan,@TotalAllowance,@TotalDeduction,@TotalOverTime,@PaymentMode,@Department,@Unit,@Zone,@JobTitle,@GradeCategory,@Grade,@Status,@GradeLevel,@Mechanised,@IsProvidentFund," +
                    "@SSNIT,@SSNITNo,@UserID,@UserName,@SSNITEmployeeRate,@SSNITEmployerRate,@SSNITFirstTierRate,@SecondTierRate,@ProvidentFundEmployeeRate,@ProvidentFundEmployerRate,@GrossSalary," +
                    "@TaxableIncome,@IsExemptFromSecondTier,@IsSusuPlusContribution,@IsWithholdingTax,@IsWithholdingTaxFixedAmount,@IsWithholdingTaxRate,@SusuPlusContribution,@WithholdingAmount," +
                    "@WithholdingFixedTaxAmount,@WithholdingTaxCalculateOn,@WithholdingTaxRate,@Bank,@BankBranch,@BankAddress,@AccountNumber,@AccountType,@AccountName,@GrandTotalAllowance," +
                    "@GrandTotalDeduction,@Email,@MobileNumber,@IsExemptAllowance,@IsExemptDeduction,@TotalOverTimeHours,@PublicHolidayOverTime,@PublicHolidayOverTimeHours,@DailyOverTime," +
                    "@DailyOverTimeHours,@HoursWorked,@WeekendOverTime,@WeekendOverTimeHours,@SaturdayOverTime,@SaturdayOverTimeHours,@SundayOverTime,@SundayOverTimeHours,@NightOverTime," +
                    "@NightOverTimeHours,@AnnualLeaveBalance,@AnnualLeave,@TotalOverTimeTax,@TotalBonus,@TotalBonusTax,@SalaryAdvance,@WageAdvance,@TotalTax,@Step,@NonAllowanceTax,@AllowanceTax," +
                    "@Overseer,@UpfrontRelief,@AnnualLeaveMonthly,@AnnualLeaveBalanceMonthly,@ExemptFirstTierRate,@TotalCost,@TotalPayable)");
                UpdateYTD(attendance);
            ...
            try
            {
                foreach (DataRow row in table.Rows)
                {
                    PayRollAttendance attendance = new PayRollAttendance()
                    {
                        ...
                        PaymentAccType=row["PaymentAccType"]==DBNull.Value?string.Empty:row["PaymentAccType"].ToString(),
        ...
        #endregion
        public void UpdateYTD(PayRollAttendance attendance)
        {
            try
            {
                //Add Year To Date Details
                dal.ClearParameters();
                ...
                var dtYTDs = dal.ExecuteReader("select sum(BasicSalary) as ytdBasic,sum(SSNITEmployee) as ytdSnitEmployee,sum(ProvidentFundEmployee) as ytdPFEmployee,sum(IncomeTax) as ytdIncomeTax,sum(NetSalary) as ytdNetSalary from StaffSalaryPaymentView where StaffID=@staffid and month<=@month and YEAR=@year");

                if (dtYTDs != null && dtYTDs.Rows.Count > 0)
                {


                    decimal ytdBasic = (dtYTDs.Rows[0]["ytdBasic"] != null) ? decimal.Parse(dtYTDs.Rows[0]["ytdBasic"].ToString()) : 0;
                    decimal ytdSnitEmployee = (dtYTDs.Rows[0]["ytdSnitEmployee"] != null) ? decimal.Parse(dtYTDs.Rows[0]["ytdSnitEmployee"].ToString()) : 0;
                    decimal ytdPFEmployee = (dtYTDs.Rows[0]["ytdPFEmployee"] != null) ? decimal.Parse(dtYTDs.Rows[0]["ytdPFEmployee"].ToString()) : 0;
                    decimal ytdIncomeTax = (dtYTDs.Rows[0]["ytdIncomeTax"] != null) ? decimal.Parse(dtYTDs.Rows[0]["ytdIncomeTax"].ToString()) : 0;
                    decimal ytdNetSalary = (dtYTDs.Rows[0]["ytdNetSalary"] != null) ? decimal.Parse(dtYTDs.Rows[0]["ytdNetSalary"].ToString()) : 0;

                    dal.CreateParameter("@ytdBasic", ytdBasic, DbType.Decimal);
                    dal.CreateParameter("@ytdSnitEmployee", ytdSnitEmployee, DbType.Decimal);
                    dal.CreateParameter("@ytdPFEmployee", ytdPFEmployee, DbType.Decimal);
                    dal.CreateParameter("@ytdIncomeTax", ytdIncomeTax, DbType.Decimal);

                    dal.CreateParameter("@ytdNetSalary", ytdNetSalary, DbType.Decimal);
                    dal.ExecuteNonQuery("update StaffSalaryPayments set ytdBasic=@ytdBasic,ytdSnitEmployee=@ytdSnitEmployee,ytdPFEmployee=@ytdPFEmployee,ytdIncomeTax=@ytdIncomeTax,ytdNetSalary=@ytdNetSalary where StaffID=@staffid and month=@month and YEAR=@year");

                    attendance.YTDBasic = ytdBasic;
                    attendance.YTDIncomeTax = ytdIncomeTax;
                    attendance.YTDNetSalary = ytdNetSalary;
                    attendance.YTDPFEmployee = ytdPFEmployee;
                    attendance.YTDSnitEmployee = ytdSnitEmployee;
                }
            }
            catch (Exception ex)
            {
