...
namespace HRDataAccessLayer.Staff_Info_Data_Control
{
    public class QualificationDataMapper
    {
        ...
        public IList<Qualification> GetAllASRaw()
        {
            IList<Qualification> qualifications = new List<Qualification>();
            try
            {
                dal = new DALHelper();
                DataTable table = dal.ExecuteReader("Select * from Qualification Where Archived='False'");
                ...
                foreach (DataRow row in table.Rows)
                {
                    qualifications.Add(new Qualification()
                    {
                        ...
                        CertificateObtained = row["Description"].ToString(),
        ...
        public Qualification GetRawQualificationByID(int Id)
        {
            IList<Qualification> qualifications = new List<Qualification>();
            Qualification qualification = new Qualification();
            try
            {
                ...
                DataTable table = dal.ExecuteReader("Select * from Qualification Where Active='true' and Archived='false' and id=@Id");

                foreach (Qualification wk in BuildRawQualificationFromData(table))
                {
                    qualification = wk;
                }
            }
            ...
            try
            {
                foreach (DataRow row in table.Rows)
                {
                    Qualification qualification = new Qualification()
                    {
                        ...
                        NameOfInstitution = row["NameOfInstitution"].ToString(),
                        CertificateObtained = row["CertificateObtained"].ToString(),
                        FromMonth =row["StartMonth"]==DBNull.Value?string.Empty: row["StartMonth"].ToString(),
                        ToMonth =row["EndMonth"]==DBNull.Value ? string.Empty: row["EndMonth"].ToString(),
                        FromYear =row["StartYear"]==DBNull.Value ?string.Empty: row["StartYear"].ToString(),
                        ToYear =row["StartYear"]==DBNull.Value ? string.Empty : row["StartYear"].ToString(),
        ...
        private IList<Qualification> BuildRawQualificationFromData(DataTable table)
        {
            IList<Qualification> qualifications = new List<Qualification>();
            try
            {
