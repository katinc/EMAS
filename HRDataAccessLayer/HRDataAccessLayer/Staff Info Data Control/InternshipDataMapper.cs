    ...
    public class InternshipDataMapper
    {
            ...
            try
             {
                 ...
                 dal.ExecuteNonQuery("Insert Into Internships(InternshipTypeID,IDNumber,StaffID,Institution,MaritalStatusID,AreaOfStudy,MobileNo,Address,GenderID,OtherName,Surname,UserID,ReportingDate,StartDate,EndDate,DOB,DepartmentID,UnitID,ZoneID,SupervisorCode,SupervisorStaffID,SupervisorName,Overseer,YearStudied) Values(@InternshipTypeID,@IDNumber,@StaffID,@Institution,@MaritalStatusID,@AreaOfStudy,@MobileNo,@Address,@GenderID,@OtherName,@Surname,@UserID,@ReportingDate,@StartDate,@EndDate,@DOB,@DepartmentID,@UnitID,@ZoneID,@SupervisorCode,@SupervisorStaffID,@SupervisorName,@Overseer,@YearStudied)");
                ...
                //dal.CreateParameter("@Overseer", internship.Overseer, DbType.String);
                //dal.CreateParameter("@YearStudied", internship.YearStudied, DbType.Decimal);
                //dal.CreateParameter("@GenderGroupID", internship.Gender, DbType.Int32);
                //dal.CreateParameter("@OtherName", internship.OtherName, DbType.String);
                //dal.CreateParameter("@Surname", internship.Surname, DbType.String);
                //dal.CreateParameter("@UserType", internship.UserType, DbType.String);
                ...
                //dal.ExecuteNonQuery("Insert Into StaffPersonalInfo(InternshipTypeID,Image,IDNumber,StaffID,Institution,MaritalStatusID,AreaOfStudy,MobileNo,Address,GenderGroupID,OtherName,Surname,UserID,ReportingDate,StartDate,EndDate,DOB,DepartmentID,UnitID,ZoneID,SupervisorCode,SupervisorStaffID,SupervisorName,Overseer,YearStudied,UserType) Values(@InternshipTypeID,@Photo,@IDNumber,@StaffID,@Institution,@MaritalStatusID,@AreaOfStudy,@MobileNo,@Address,@GenderGroupID,@OtherName,@Surname,@UserID,@ReportingDate,@StartDate,@EndDate,@DOB,@DepartmentID,@UnitID,@ZoneID,@SupervisorCode,@SupervisorStaffID,@SupervisorName,@Overseer,@YearStudied,@UserType)");
        ...
        public void Update(object item)
        {
            try
            {
                ...
                //dal.ExecuteNonQuery("Update StaffPersonalInfo Set MobileNo=@MobileNo,Address=@Address,Image=@Photo,ZoneID=@ZoneID,InternshipTypeID=@InternshipTypeID,IDNumber=@IDNumber,StaffID=@StaffID,Institution=@Institution,MaritalStatusID=@MaritalStatusID,AreaOfStudy=@AreaOfStudy,GenderGroupID=@GenderID,OtherName=@OtherName,Surname=@Surname,UserID=@UserID,ReportingDate=@ReportingDate,StartDate=@StartDate,EndDate=@EndDate,DOB=@DOB,DepartmentID=@DepartmentID,UnitID=@UnitID,SupervisorCode=@SupervisorCode,SupervisorStaffID=@SupervisorStaffID,SupervisorName=@SupervisorName,Overseer=@Overseer,YearStudied=@YearStudied Where ID =@ID and Archived=@Archived");
        ...
        public IList<Internship> GetByCriteria(Query query1)
        {
            ...
            try
            {
                ...
                dal.ClearParameters();
                dal.CreateParameter("@Archived", internship.Archived, DbType.Boolean);
                string query = "select InternshipView.* from InternshipView ";
                string selectStatement = QueryTranslater.TranslateQuery(query, query1);
                if (!selectStatement.Trim().Contains("Where"))
                {
        ...
        public void Delete(object item)
        {
            try
            {
                ...
                dal.CreateParameter("@ID", internship.ID, DbType.Int32);
                dal.CreateParameter("@Archived", internship.Archived, DbType.Boolean);
                dal.ExecuteNonQuery("Update StaffPersonalInfo Set Archived=@Archived Where id =@ID");
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
        ...
        public Internship ShowImageByStaffID(object item)
        {
            ...
            try
            {
                ...
                string query = "SELECT InternshipView.ID,InternshipView.IDNumber,InternshipView.Image From InternshipView Where IDNumber=@IDNumber AND Archived=@Archived";
                DataTable table = dal.ExecuteReader(query);
