...
namespace HRDataAccessLayer
{
    public class DAL : IDAL
    {
        ...
        public void Save(object item)
        {
            ...
            else if (item.GetType() == typeof(PublicHoliday))
            {
                PublicHolidaysDataMapper edm = new PublicHolidaysDataMapper();
                try
                {
                    edm.Save(item);
                }
            ...
            else if (item.GetType() == typeof(StaffTraining))
            {
                StaffTrainingDataMapper edm = new StaffTrainingDataMapper();
                try
                {
                    edm.Save(item);
                }
        ...
        public IList<T> GetByCriteria<T>(Query query) where T : class
        {
            ...
            else if (typeof(T) == typeof(SingleSpine))
            {
        ...
        public IList<T> GetAll<T>() where T : class
        {
            ...
            else if (typeof(T) == typeof(PublicHoliday))
            {
                PublicHolidaysDataMapper mapper = new PublicHolidaysDataMapper();
                try
                {
                    return (IList<T>)mapper.GetAll();
                }
            ...
            else if (typeof(T) == typeof(Directorate))
            {
                DirectorateDataMapper mapper = new DirectorateDataMapper();
                try
                {
                    return (IList<T>)mapper.GetAll();
                }
            ...
            else if (typeof(T) == typeof(TrainingType))
            {
                TrainingTypeDataMapper mapper = new TrainingTypeDataMapper();
                try
                {
                    return (IList<T>)mapper.GetAll();
                }
            ...
            {
                SponsorDataMapper mapper = new SponsorDataMapper();
                try
                {
                    return (IList<T>)mapper.GetAll();
                }
            ...
            else if (typeof(T) == typeof(LocationType))
            {
                LocationTypeDataMapper mapper = new LocationTypeDataMapper();
                try
                {
                    return (IList<T>)mapper.GetAll();
                }
            ...
            else if (typeof(T) == typeof(Organizers))
            {
                OrganizersDataMapper mapper = new OrganizersDataMapper();
                try
                {
                    return (IList<T>)mapper.GetAll();
                }
            ...
            //else if (typeof(T) == typeof(InServiceTraining))
            //{
            //    InServiceTrainingDataMapper mapper = new InServiceTrainingDataMapper();
            //    try
            //    {
            //        return (IList<T>)mapper.GetAll();
            //    }
