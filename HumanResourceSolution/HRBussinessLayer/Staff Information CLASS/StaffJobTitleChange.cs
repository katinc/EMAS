...
{
    public class StaffJobTitleChange
    {
        private int id;
        private Employee employee;
        private string staffName;
        private Nullable<DateTime> date;
        private JobTitle jobTitleFrom;
        private JobTitle jobTitleTo;
        ...
        public StaffJobTitleChange()
        {
            ...
            this.archived = false;
            this.jobTitleFrom = new JobTitle();
            this.jobTitleTo = new JobTitle();
            this.user = new User();
        }
        ...
        public JobTitle JobTitleFrom
        {
            get { return jobTitleFrom; }
            set { jobTitleFrom = value;}
        }

        public JobTitle JobTitleTo
        {
            get { return jobTitleTo; }
            set { jobTitleTo = value; }
        }
