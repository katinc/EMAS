...
{
    public class StaffAppointmentTypeChange
    {
        private int id;
        private Employee employee;
        private string staffName;
        private Nullable<DateTime> date;
        private AppointmentType appointmentTypeFrom;
        private AppointmentType appointmentTypeTo;
        ...
        public StaffAppointmentTypeChange()
        {
            this.id = 0;
            ...
            this.archived = false;
            this.appointmentTypeFrom = new AppointmentType();
            this.appointmentTypeTo = new AppointmentType();
            this.user = new User();
        }
        ...
        public AppointmentType AppointmentTypeFrom
        {
            get { return appointmentTypeFrom; }
            set { appointmentTypeFrom = value; }
        }

        public AppointmentType AppointmentTypeTo
        {
            get { return appointmentTypeTo; }
            set { appointmentTypeTo = value; }
        }
