...
{
    public class StaffStatusChange
    {
        private int id;
        private Employee employee;
        private string staffName;
        private Nullable<DateTime> date;
        private StaffStatus staffStatusFrom;
        private StaffStatus staffStatusTo;
        ...
        public StaffStatusChange()
        {
            ...
            this.archived = false;
            this.staffStatusFrom = new StaffStatus();
            this.staffStatusTo = new StaffStatus();
            this.user = new User();
        }
        ...
        public StaffStatus StaffStatusFrom
        {
            get { return staffStatusFrom; }
            set { staffStatusFrom = value; }
        }

        public StaffStatus StaffStatusTo
        {
            get { return staffStatusTo; }
            set { staffStatusTo = value; }
        }
