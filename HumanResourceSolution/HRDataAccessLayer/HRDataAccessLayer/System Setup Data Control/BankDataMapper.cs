    ...
    public class BankDataMapper
    {
        ...
        public void Save(object item)
        {
            try
            {
                ...
                dal.ExecuteNonQuery("Insert Into Banks(Code,Description,Active,UserID) Values(@Code,@Description,@Active,@UserID)");
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
        ...
        public void Update(object item)
        {
            try
            {
                ...
                dal.ExecuteNonQuery("Update Banks Set Code=@Code,Description=@Description,Active=@Active,UserID=@UserID Where ID =@ID and Archived=@Archived");
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
