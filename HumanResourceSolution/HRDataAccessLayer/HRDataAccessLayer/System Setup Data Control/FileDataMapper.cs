    ...
    public class FileDataMapper
    {
        ...
        public void Save(object item)
        {
            try
            {
                ...
                dal.ExecuteNonQuery("Insert Into FileNumber (Description,InUse,UserID) Values(@Description,@InUse,@UserID)");
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        public IList<FileNumber> GetByCriteria(Query query1)
        {
            ...
            selectStatement += "  FileNumberView.Archived=@Archive order BY FileNumberView.Description ASC";
