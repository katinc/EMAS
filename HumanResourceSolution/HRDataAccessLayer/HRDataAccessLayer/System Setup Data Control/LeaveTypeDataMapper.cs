    ...
    public class LeaveTypeDataMapper
    {
        ...
        public void Save(object item)
        {
            try
            {
                ...
                dal.ExecuteNonQuery("Insert Into LeaveTypes (Description,MaximumEntitlement,Active,UserID) Values(@Description,@MaximumEntitlement,@Active,@UserID)");
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
        ...
        public void Update(object item)
        {
            try
            {
                ...
                dal.ExecuteNonQuery("Update LeaveTypes Set Description=@Description,MaximumEntitlement=@MaximumEntitlement,Active=@Active,UserID=@UserID Where ID =@ID");
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
        ...
        public IList<LeaveType> GetByCriteria(Query query1)
        {
            ...
            try
            {
                ...
                selectStatement += " Archived='False' order BY LeaveTypeView.Description ASC";
