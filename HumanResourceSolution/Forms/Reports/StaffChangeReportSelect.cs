...
{
    public partial class StaffChangeReportSelect : Form
    {
        private IDAL dal;
        ...
        public StaffChangeReportSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (cboReportType.Text.ToLower().Trim() != string.Empty)
                {
                    if (cboReportType.Text.Trim() == "dob changes")
                    {
                        ...
                        reportForm = new StaffChangeDOBForm(staffIDtxt.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                        reportForm.Show();
                    }
                    else if (cboReportType.Text.ToLower().Trim() == "appointment type changes")
                    {
                        if (reportForm != null && !reportForm.IsDisposed)
                        {
                            reportForm.Close();
                        ...
                        reportForm = new StaffChangeAppointmentTypeForm(staffIDtxt.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                        reportForm.Show();
                    }
                    else if (cboReportType.Text.ToLower().Trim() == "job title hanges")
                    {
                        if (reportForm != null && !reportForm.IsDisposed)
                        {
                            reportForm.Close();
                        ...
                        reportForm = new StaffChangeJobTitleForm(staffIDtxt.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                        reportForm.Show();
                    }
                    else if (cboReportType.Text.ToLower().Trim() == "employment date changes")
                    {
                        if (reportForm != null && !reportForm.IsDisposed)
                        {
                            reportForm.Close();
                        ...
                        reportForm = new StaffChangeEmploymentDateForm(staffIDtxt.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                        reportForm.Show();
                    }
                    else if (cboReportType.Text.ToLower().Trim() == "grade changes")
                    {
                        if (reportForm != null && !reportForm.IsDisposed)
                        {
                            reportForm.Close();
                        ...
                        reportForm = new StaffChangeGradeForm(staffIDtxt.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                        reportForm.Show();
                    }
                    else if (cboReportType.Text.ToLower().Trim() == "name changes")
                    {
                        if (reportForm != null && !reportForm.IsDisposed)
                        {
                            reportForm.Close();
                        ...
                        reportForm = new StaffChangeNameForm(staffIDtxt.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                        reportForm.Show();
                    }
                    else if (cboReportType.Text.ToLower().Trim() == "status changes")
                    {
                        if (reportForm != null && !reportForm.IsDisposed)
                        {
                            reportForm.Close();
                        ...
                        reportForm = new StaffChangeStatusForm(staffIDtxt.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                        reportForm.Show();
                    }
                }
                else
        ...
        private void StaffChangeReportSelect_Load(object sender, EventArgs e)
        {
            try
            {
