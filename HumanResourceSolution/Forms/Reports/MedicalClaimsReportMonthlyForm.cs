...
{
    public partial class MedicalClaimsReportMonthlyForm : Form
    {
        private IDAL dal;
        ...
        public MedicalClaimsReportMonthlyForm(string staffID,string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = MedicalCliamsMonthly1.Database;
        ...
        public MedicalClaimsReportMonthlyForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void MedicalClaimsReportMonthlyForm_Load(object sender, EventArgs e)
        {
            try
            {
