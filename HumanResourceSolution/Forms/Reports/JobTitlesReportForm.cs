...
{
    public partial class JobTitlesReportForm : Form
    {
        private IDAL dal;
        public JobTitlesReportForm()
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            Database mydatabase = JobTitles1.Database;
        ...
        private void JobTitlesReportForm_Load(object sender, EventArgs e)
        {
            try
            {
