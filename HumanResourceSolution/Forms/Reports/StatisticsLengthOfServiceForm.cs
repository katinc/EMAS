...
{
    public partial class StatisticsLengthOfServiceForm : Form
    {
        private IDAL dal;
        ...
        public StatisticsLengthOfServiceForm(bool isAsAtDateChecked, DateTime asAtDate)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StatisticsLengthOfService1.Database;
        ...
        public StatisticsLengthOfServiceForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StatisticsLengthOfServiceForm_Load(object sender, EventArgs e)
        {
            try
            {
