...
{
    public partial class StaffChangeGradeForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeGradeForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangeGradeReport1.Database;
        ...
        private void StaffChangeGradeForm_Load(object sender, EventArgs e)
        {
            try
            {
