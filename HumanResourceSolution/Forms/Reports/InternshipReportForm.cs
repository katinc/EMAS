...
{
    public partial class InternshipReportForm : Form
    {
        private IDAL dal;
        ...
        public InternshipReportForm(string idNumber, string internshipType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string zone, string staffID)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "InternshipType";
                paramDiscreteValue.Value = internshipType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                paramDiscreteValue.Value = idNumber;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = InternshipReport1.Database;
        ...
        private void InternshipReportForm_Load(object sender, EventArgs e)
        {
            try
            {
