...
{
    public partial class ProvidentEmployeeForm : Form
    {
        private IDAL dal;
        ...
        public ProvidentEmployeeForm(string month,string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = ProvidentReturnsEmployee1.Database;
        ...
        private void ProvidentEmployeeForm_Load(object sender, EventArgs e)
        {
            try
            {
