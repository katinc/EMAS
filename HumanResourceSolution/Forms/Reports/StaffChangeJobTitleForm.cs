...
{
    public partial class StaffChangeJobTitleForm : Form
    {
        private IDAL dal;
        ...
        public StaffChangeJobTitleForm(string staffID, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffChangeJobTitleReport1.Database;
        ...
        public StaffChangeJobTitleForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffChangeJobTitleForm_Load(object sender, EventArgs e)
        {
            try
            {
