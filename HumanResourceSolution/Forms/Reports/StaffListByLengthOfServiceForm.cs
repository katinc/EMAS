...
{
    public partial class StaffListByLengthOfServiceForm : Form
    {
        private IDAL dal;
        ...
        public StaffListByLengthOfServiceForm(bool isAsAtDateChecked, DateTime asAtDate, decimal ageFrom, decimal ageTo)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StaffProfileByLengthOfService1.Database;
        ...
        public StaffListByLengthOfServiceForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffListByLengthOfServiceForm_Load(object sender, EventArgs e)
        {
            try
            {
