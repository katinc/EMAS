...
{
    public partial class DutyRoasterReportForm : Form
    {
        private IDAL dal;
        ...
        public DutyRoasterReportForm(string startDate, string endDate)
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            paramDiscreteValue.Value = "DUTY ROASTER FOR THE PERIOD " + startDate + " TO " + endDate;
            ...
            Database mydatabase = dutyRosterReport1.Database;
