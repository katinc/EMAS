...
namespace eMAS.Forms.Reports
{
    public partial class SMSReportForm : Form
    {
        ...
        public SMSReportForm(bool isFromDate, DateTime fromDate,bool isToDate, DateTime toDate,string type)
        {
            try
            {
                InitializeComponent();
                ...
                paramField.Name = "IsFromDate";
                paramDiscreteValue.Value = isFromDate;
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "IsToDate";
                paramDiscreteValue.Value = isToDate;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = SMSReport1.Database;
