...
{
    public partial class PayrollCombineRegisterSummaryReportForm : Form
    {
        ...
        public PayrollCombineRegisterSummaryReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayrollCombineRegisterSummaryReport1.Database;
        ...
        public PayrollCombineRegisterSummaryReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PayrollCombineRegisterSummaryReportForm_Load(object sender, EventArgs e)
        {
            try
            {
