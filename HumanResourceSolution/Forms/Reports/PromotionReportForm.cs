...
{
    public partial class PromotionReportForm : Form
    {
        private IDAL dal;
        ...
        public PromotionReportForm(string staffID, string promotionType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "PromotionType";
                paramDiscreteValue.Value = promotionType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = StaffPromotionReport1.Database;
        ...
        private void PromotionReportForm_Load(object sender, EventArgs e)
        {
            try
            {
