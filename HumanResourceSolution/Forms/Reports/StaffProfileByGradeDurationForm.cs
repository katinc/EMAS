...
{
    public partial class StaffProfileByGradeDurationForm : Form
    {
        private IDAL dal;
        ...
        public StaffProfileByGradeDurationForm(bool isAsAtDateChecked, DateTime asAtDate, decimal promotionOver)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "PromotionOver";
                paramDiscreteValue.Value = promotionOver;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = StaffProfileByGradeDuration1.Database;
        ...
        public StaffProfileByGradeDurationForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StaffProfileByGradeDurationForm_Load(object sender, EventArgs e)
        {
            try
            {
