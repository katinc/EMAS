...
{
    public partial class SSNITSecondTierPensionPaymentForm : Form
    {
        private IDAL dal;
        ...
        public SSNITSecondTierPensionPaymentForm(string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SSNITSecondTierPensionPaymentReport1.Database;
        ...
        public SSNITSecondTierPensionPaymentForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITSecondTierPensionPaymentForm_Load(object sender, EventArgs e)
        {
            try
            {
