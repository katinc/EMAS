...
namespace eMAS.Forms.Reports
{
    public partial class VacanciesReportForm : Form
    {
        ...
        public VacanciesReportForm(string startDate, string endDate)
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            paramDiscreteValue.Value = "VACANCIES REPORT FOR THE PERIOD "+ startDate +" TO "+ endDate;
            ...
            Database mydatabase = vacanciesReport1.Database;
