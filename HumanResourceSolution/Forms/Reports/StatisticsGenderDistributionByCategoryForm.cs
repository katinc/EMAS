...
{
    public partial class StatisticsGenderDistributionByCategoryForm : Form
    {
        private IDAL dal;
        ...
        public StatisticsGenderDistributionByCategoryForm(bool isAsAtDateChecked, DateTime asAtDate)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StatisticsGenderDistributionByCategory1.Database;
        ...
        public StatisticsGenderDistributionByCategoryForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StatisticsGenderDistributionByCategoryForm_Load(object sender, EventArgs e)
        {
            try
            {
