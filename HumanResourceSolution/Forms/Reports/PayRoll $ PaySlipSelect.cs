    ...
    public partial class PayRoll_PaySlip : Form
    {
        ...
        private static void RunReport(object value)
        {
            try
            {
                ...
                {
                    data.report = new PayRollOldReportForm2(data.StaffID,data.Month, data.Year, data.Depart, data.Unit, data.GradeCat, data.Grade, data.Zone, data.Mechanised, frm);
                }
                else if (data.Format.ToLower().Trim() == "payroll register".Trim())
                {
                    data.report = new PayRollOldReportForm3(data.StaffID, data.Month, data.Year, data.Depart, data.Unit, data.GradeCat, data.Grade, data.Zone, data.Mechanised, frm);
                }
                ...
                {
                    data.report = new PayRollCombinedRegisterReportForm(data.StaffID, data.Month, data.Year, data.Depart, data.Unit, data.GradeCat, data.Grade, data.Zone, data.Mechanised, frm);
                }
                ...
                {
                    data.report = new PayRollMasterListReportForm(data.StaffID, data.Month, data.Year, data.Depart, data.Unit, data.GradeCat, data.Grade, data.Zone, data.Mechanised, frm);
                }
                ...
                {
                    data.report = new PayrollCombineRegisterDetailReportForm(data.StaffID, data.Month, data.Year, data.Depart, data.Unit, data.GradeCat, data.Grade, data.Zone, data.Mechanised, frm);
