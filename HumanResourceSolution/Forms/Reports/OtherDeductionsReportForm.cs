...
{
    public partial class OtherDeductionsReportForm : Form
    {
        private IDAL dal;
        ...
        public OtherDeductionsReportForm(string staffID,string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = OtherDeductions1.Database;
        ...
        public OtherDeductionsReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void OtherDeductionsReportForm_Load(object sender, EventArgs e)
        {
            try
            {
