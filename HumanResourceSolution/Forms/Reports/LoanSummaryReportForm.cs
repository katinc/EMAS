...
{
    public partial class LoanSummaryReportForm : Form
    {
        private IDAL dal;
        ...
        public LoanSummaryReportForm(string staffID,string month,string year,string loanType, string department, string unit, string gradeCategory, string grade, string zone, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "LoanType";
                paramDiscreteValue.Value = loanType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = LoanSummaryReport1.Database;
        ...
        private void LoanSummaryReportForm_Load(object sender, EventArgs e)
        {
            try
            {
