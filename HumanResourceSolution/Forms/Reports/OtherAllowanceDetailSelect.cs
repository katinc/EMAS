...
{
    public partial class OtherAllowanceDetailSelect : Form
    {
        ...
        public OtherAllowanceDetailSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void OtherAllowanceDetailSelect_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbOption.Text.Trim() == "Individual Employee")
                {
                    if (ValidateFields())
                    {
                        ...
                        else
                        {
                            ...
                            reportForm = new OtherAllowanceDetailForm(staffIDtxt.Text.Trim(), monthComboBox.Text.Trim(), yearComboBox.Text.Trim(),cboAllowanceType.Text.Trim(),cboMechanised.Text.Trim());
                            reportForm.Show();
                        }
                    }
                }
        ...
        private void cboAllowanceType_DropDown(object sender, EventArgs e)
        {
            try
            {
                cboAllowanceType.Items.Clear();
                cboAllowanceType.Items.Add("All");
                allowanceTypes=dal.GetAll<Allowance>();
                foreach (Allowance allowanceType in allowanceTypes)
                {
                    cboAllowanceType.Items.Add(allowanceType.Description);
                }
            }
            catch (Exception ex)
            {
