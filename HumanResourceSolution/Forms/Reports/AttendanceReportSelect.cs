...
namespace eMAS.Forms.Reports
{
    public partial class AttendanceReportSelect : Form
    {
        ...
        private void cboType_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (cboType.Text.ToLower().Trim() == "all" || cboType.Text.ToLower().Trim() == string.Empty)
                {
                    type = "All";
                }
                else if (cboType.Text.ToLower().Trim() == "clock in")
                {
                    type = "I";
                }
                else if (cboType.Text.ToLower().Trim() == "clock out")
                {
                    type = "O";
                }
            }
        ...
        private void cboType_DropDown(object sender, EventArgs e)
        {
            try
            {
                ...
                cboType.Items.Add("Clock In");
                cboType.Items.Add("Clock Out");
            }
            catch (Exception ex)
            {
                Logger.LogError(ex);
