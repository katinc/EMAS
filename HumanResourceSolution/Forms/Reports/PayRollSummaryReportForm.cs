...
{
    public partial class PayRollSummaryReportForm : Form
    {
        ...
        public PayRollSummaryReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayrollSummary1.Database;
        ...
        public PayRollSummaryReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PayRollSummaryReportForm_Load(object sender, EventArgs e)
        {
            try
            {
