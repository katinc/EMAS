...
{
    public partial class SanctionReportForm : Form
    {
        private IDAL dal;
        ...
        public SanctionReportForm(string staffID, string sanctionType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "SanctionType";
                paramDiscreteValue.Value = sanctionType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = SanctionReport1.Database;
        ...
        private void SanctionReportForm_Load(object sender, EventArgs e)
        {
            try
            {
