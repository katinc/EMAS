...
{
    public partial class MedicalClaimsReportSelect : Form
    {
        private IDAL dal;
        ...
        public MedicalClaimsReportSelect()
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            try
            {
                if (cmbOption.Text.Trim() == "Individual Employee")
                {
                    if (ValidateFields())
                    {
                        ...
                        {
                            MessageBox.Show("The Selected Staff has not Submitted any Medical Claims");
                        }
                        else
                        {
                            if (cboFormat.Text.ToLower().Trim() == "detail")
                            {
                                if (reportForm != null && !reportForm.IsDisposed)
                                {
                                    reportForm.Close();
                                }
                                reportForm = new MedicalClaimsReportDetailForm(staffIDtxt.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboZone.Text.Trim(), cboMechanised.Text.Trim());
                                reportForm.Show();
                            }
                            else
                            {
                                ...
                                reportForm = new MedicalClaimsReportForm(staffIDtxt.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboZone.Text.Trim(), cboMechanised.Text.Trim());
                                reportForm.Show();
                            }
                        }
                    }
