...
{
    public partial class SSNITPaymentVoucherSelect : Form
    {
        ...
        public SSNITPaymentVoucherSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITPaymentVoucherSelect_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (monthComboBox.Text.Trim() != string.Empty && yearComboBox.Text != string.Empty)
                {
                    ...
                    if (payRollAttendances.Count > 0)
                    {
                        if (cboFormat.Text.ToLower() == "name separated")
                        {
                            ...
                            reportForm = new SSNITPaymentVoucherFormatForm(monthComboBox.Text.Trim(), yearComboBox.Text.Trim(), cboMechanised.Text.Trim());
                            reportForm.Show();
                        }
                        else
                        {
                            ...
                            reportForm = new SSNITPaymentVoucherForm(monthComboBox.Text.Trim(), yearComboBox.Text.Trim(), cboMechanised.Text.Trim());
                            reportForm.Show();
                        }
                    }
                    else
