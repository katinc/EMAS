...
{
    public partial class SeparationReportForm : Form
    {
        private IDAL dal;
        ...
        public SeparationReportForm(string staffID, string separationType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string unit, string gradeCategory, string grade, string zone)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "SeparationType";
                paramDiscreteValue.Value = separationType;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
                ...
                Database mydatabase = SeparationReport1.Database;
        ...
        private void SeparationReportForm_Load(object sender, EventArgs e)
        {
            try
            {
