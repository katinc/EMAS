...
{
    public partial class SSNITReturnsEmployeeForm : Form
    {
        private IDAL dal;
        ...
        public SSNITReturnsEmployeeForm(string month,string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SSNITReturnsEmployee1.Database;
        ...
        public SSNITReturnsEmployeeForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITReturnsEmployeeForm_Load(object sender, EventArgs e)
        {
            try
            {
