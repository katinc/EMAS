...
{
    public partial class ProvidentAllForm : Form
    {
        private IDAL dal;
        ...
        public ProvidentAllForm(string month, string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = AllProvidentReturnsReport1.Database;
        ...
        private void ProvidentAllForm_Load(object sender, EventArgs e)
        {
            try
            {
