...
{
    public partial class StatisticsAgeDistributionByAgeRangeForm : Form
    {
        private IDAL dal;
        ...
        public StatisticsAgeDistributionByAgeRangeForm(bool isAsAtDateChecked, DateTime asAtDate)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StatisticsAgeDistributionByAgeRange1.Database;
        ...
        public StatisticsAgeDistributionByAgeRangeForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StatisticsAgeDistributionByAgeRangeForm_Load(object sender, EventArgs e)
        {
            try
            {
