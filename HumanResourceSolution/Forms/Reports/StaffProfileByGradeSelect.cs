...
{
    public partial class StaffProfileByGradeSelect : Form
    {
        ...
        public StaffProfileByGradeSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                reportForm = new StaffProfileByGradeForm(cboDepartment.Text, cboUnit.Text, cboZone.Text, cboGender.Text, cboGradeCategory.Text, cboGrade.Text);
                reportForm.Show();
            }
            catch (Exception ex)
            {
        ...
        private void StaffProfileByGradeSelect_Load(object sender, EventArgs e)
        {
