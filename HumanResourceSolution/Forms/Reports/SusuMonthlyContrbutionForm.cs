...
{
    public partial class SusuMonthlyContrbutionForm : Form
    {
        private IDAL dal;
        ...
        public SusuMonthlyContrbutionForm(string staffID,string month,string year)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SusuMonthlyContributionReport1.Database;
        ...
        public SusuMonthlyContrbutionForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SusuMonthlyContrbutionForm_Load(object sender, EventArgs e)
        {
            try
            {
