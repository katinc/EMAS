...
{
    public partial class PayRollSummaryByGradeReportForm : Form
    {
        ...
        public PayRollSummaryByGradeReportForm(string staffID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised, PleaseWait frm)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = PayrollSummaryByGrade1.Database;
        ...
        public PayRollSummaryByGradeReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void PayRollSummaryByGradeReportForm_Load(object sender, EventArgs e)
        {
            try
            {
