...
namespace eMAS.Forms.Reports
{
    public partial class PayRollOldReportForm2 : Form
    {
        ...
        public PayRollOldReportForm2(string staffID,string  month, string  year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised,PleaseWait frm)
        {
            try
            {
                InitializeComponent();
