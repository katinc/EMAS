...
{
    public partial class BankAdviceSlipReportForm : Form
    {
        private IDAL dal;
        ...
        public BankAdviceSlipReportForm(string staffID, string month, string year, string zone ,string department,string unit,string gradeCategory,string grade, string bank, string bankBranch, string accountType, string accountNumber,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = BankAdviceSlipReport1.Database;
        ...
        public BankAdviceSlipReportForm()
        {
            try
            {
                InitializeComponent();
