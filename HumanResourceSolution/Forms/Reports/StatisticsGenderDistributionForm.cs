...
{
    public partial class StatisticsGenderDistributionForm : Form
    {
        private IDAL dal;
        ...
        public StatisticsGenderDistributionForm(bool isAsAtDateChecked, DateTime asAtDate)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = StatisticsGenderDistribution1.Database;
        ...
        public StatisticsGenderDistributionForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void StatisticsGenderDistributionForm_Load(object sender, EventArgs e)
        {
            try
            {
