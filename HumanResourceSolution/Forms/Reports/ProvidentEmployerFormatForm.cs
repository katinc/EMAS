...
{
    public partial class ProvidentEmployerFormatForm : Form
    {
        private IDAL dal;
        ...
        public ProvidentEmployerFormatForm(string month, string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = ProvidentReturnsEmployerFormat1.Database;
        ...
        public ProvidentEmployerFormatForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void ProvidentEmployerFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
