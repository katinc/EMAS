...
{
    public partial class SSNITReturnsReportFormatForm : Form
    {
        private IDAL dal;
        ...
        public SSNITReturnsReportFormatForm(string month, string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SSNITReturnsFormat1.Database;
        ...
        public SSNITReturnsReportFormatForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITReturnsReportFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
