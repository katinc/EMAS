...
{
    public partial class ZonesReportForm : Form
    {
        private IDAL dal;
        public ZonesReportForm()
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            Database mydatabase = Zones1.Database;
        ...
        private void ZonesReportForm_Load(object sender, EventArgs e)
        {
            try
            {
