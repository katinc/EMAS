...
{
    public partial class ApplicantReportForm : Form
    {
        private IDAL dal;
        ...
        public ApplicantReportForm(string name, string appointmentType, bool isDateFromChecked, bool isDateToChecked, DateTime dateFrom, DateTime dateTo, string department, string grade, string applicationStatus)
        {
            try
            {
                InitializeComponent();
                ...
                paramField = new ParameterField();
                paramDiscreteValue = new ParameterDiscreteValue();
                paramField.Name = "ApplicationStatus";
                paramDiscreteValue.Value = applicationStatus;
                paramField.CurrentValues.Add(paramDiscreteValue);
                paramFields.Add(paramField);
        ...
        private void ApplicantReportForm_Load(object sender, EventArgs e)
        {
            try
            {
