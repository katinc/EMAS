...
{
    public partial class ProvidentAllFormatForm : Form
    {
        private IDAL dal;
        ...
        public ProvidentAllFormatForm(string month, string year, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = AllProvidentReturnsFormatReport1.Database;
        ...
        private void ProvidentAllFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
