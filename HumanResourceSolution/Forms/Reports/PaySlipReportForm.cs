...
namespace eMAS.Forms.Reports
{
    public partial class PaySlipReportForm : Form
    {
        ...
        public PaySlipReportForm(string staffID, int paymentID, string month, string year, string department, string unit, string gradeCategory, string grade, string zone, string mechanised)
        {
            try
            {
                InitializeComponent();
