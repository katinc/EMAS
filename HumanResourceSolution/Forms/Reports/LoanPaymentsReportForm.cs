...
{
    public partial class LoanPaymentsReportForm : Form
    {
        private IDAL dal;
        ...
        public LoanPaymentsReportForm(bool isAsAtDateChecked, DateTime asAtDate, string staffID)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = loanPayments1.Database;
        ...
        private void LoanPaymentsReportForm_Load(object sender, EventArgs e)
        {
            try
            {
