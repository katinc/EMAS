...
{
    public partial class BanksReportForm : Form
    {
        private IDAL dal;
        public BanksReportForm()
        {
            InitializeComponent();
            this.dal = new DAL();
            ...
            Database mydatabase = Banks1.Database;
        ...
        private void BanksReportForm_Load(object sender, EventArgs e)
        {
            try
            {
