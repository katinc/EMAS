...
{
    public partial class MedicalClaimsReportDetailForm : Form
    {
        private IDAL dal;
        ...
        public MedicalClaimsReportDetailForm(string staffID, string gradeCategory, string grade, string department, string unit, string zone,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = MedicalClaimsDetail1.Database;
        ...
        public MedicalClaimsReportDetailForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void MedicalClaimsReportDetailForm_Load(object sender, EventArgs e)
        {
            try
            {
