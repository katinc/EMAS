...
{
    public partial class SSNITSecondTierPensionPaymentFormatForm : Form
    {
        private IDAL dal;
        ...
        public SSNITSecondTierPensionPaymentFormatForm(string month,string year,string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = SSNITSecondTierPensionPaymentFormatReport1.Database;
        ...
        public SSNITSecondTierPensionPaymentFormatForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void SSNITSecondTierPensionPaymentFormatForm_Load(object sender, EventArgs e)
        {
            try
            {
