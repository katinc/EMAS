...
{
    public partial class PromotionReportSelect : Form
    {
        private IDAL dal;
        ...
        private void cmbOption_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbOption.Text.ToLower() != "individual")
                {
                    ...
                    lblPromotionType.Visible = true;
                    cboPromotionType.Visible = true;
                }
                else
                {
                    ...
                    lblPromotionType.Visible = false;
                    cboPromotionType.Visible = false;
                }
            }
            catch (Exception ex)
            {
                ...
                if (cmbOption.Text.Trim() == "Individual Employee")
                {
                    if (ValidateFields())
                    {
                        ...
                        else
                        {
                            ...
                            reportForm = new PromotionReportForm(staffIDtxt.Text.Trim(), cboPromotionType.Text.Trim(), datePickerFrom.Checked, datePickerTo.Checked, datePickerFrom.Value, datePickerTo.Value, cboDepartment.Text.Trim(), cboUnit.Text.Trim(), cboGradeCategory.Text.Trim(), cboGrade.Text.Trim(), cboZone.Text.Trim());
                            reportForm.Show();
                        }
                    }
                }
        ...
        private void PromotionReportSelect_Load(object sender, EventArgs e)
        {
            try
            {
