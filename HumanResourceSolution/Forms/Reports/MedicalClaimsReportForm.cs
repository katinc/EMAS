...
{
    public partial class MedicalClaimsReportForm : Form
    {
        private IDAL dal;
        ...
        public MedicalClaimsReportForm(string staffID, string gradeCategory, string grade, string department, string unit, string zone, string mechanised)
        {
            try
            {
                InitializeComponent();
                ...
                Database mydatabase = MedicalClaimsReport1.Database;
        ...
        public MedicalClaimsReportForm()
        {
            try
            {
                InitializeComponent();
        ...
        private void MedicalClaimsReportForm_Load(object sender, EventArgs e)
        {
            try
            {
