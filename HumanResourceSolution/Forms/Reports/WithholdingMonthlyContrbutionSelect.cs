...
{
    public partial class WithholdingMonthlyContrbutionSelect : Form
    {
        ...
        public WithholdingMonthlyContrbutionSelect()
        {
            try
            {
                InitializeComponent();
        ...
        private void WithholdingMonthlyContrbutionSelect_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cmbOption.Text.Trim() == "Individual Employee")
                {
                    if (ValidateFields())
                    {
                        ...
                        else
                        {
                            ...
                            reportForm = new WithholdingMonthlyContrbutionForm(staffIDtxt.Text.Trim(), monthComboBox.Text.Trim(), yearComboBox.Text.Trim(), cboMechanised.Text.Trim());
                            reportForm.Show();
                        }
                    }
                }
