...
namespace eMAS.All_UIs.Staff_Information_FORMS
{
	...
	*/
	...
	{
        private EmployeeMaintenance employeeForm;

        public EnrollmentForm(EmployeeMaintenance employeeForm)
            : base()
        {
        ...
        public override void CloseButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    employeeForm.Template = Enroller.Template;
                    employeeForm.FingerPrint = base.FingerPrint;
                    employeeForm.Verified = true;
                }
                else
                {
                    employeeForm.Verified = false;
                }
            }
            catch (Exception ex)
            {
