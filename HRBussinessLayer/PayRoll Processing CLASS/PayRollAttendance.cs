...
namespace HRBussinessLayer.PayRoll_Processing_CLASS
{
    public class PayRollAttendance
    {
        ...
        private decimal ytdBasic;
        private decimal ytdSnitEmployee;
        private decimal ytdPFEmployee;
        private decimal ytdIncomeTax;
        private decimal ytdNetSalary;

        private decimal taxRelief;
        private int taxReliefYear;
        private int taxReliefMonth;
        ...
        public PayRollAttendance()
        {
            try
            {
                ...
                this.ytdIncomeTax = 0;
                this.ytdNetSalary = 0;
                this.ytdPFEmployee = 0;
                this.ytdSnitEmployee=0;

                this.taxRelief = 0;
                this.taxReliefYear = 0;
                this.taxReliefMonth = 0;
            }
            catch(Exception ex)
            {
                Logger.LogError(ex);
        ...
        {
            get { return taxRelief; }
            set { taxRelief = value; }
        }

        public int TaxReliefYear
        {
            get { return taxReliefYear; }
            set { taxReliefYear = value; }
        }

        public int TaxReliefMonth
        {
            get { return taxReliefMonth; }
            set { taxReliefMonth = value; }
        }
        ...
        public decimal YTDBasic
        {
            get { return ytdBasic; }
            set { ytdBasic = value; }
        }

        public decimal YTDSnitEmployee
        {
            get { return ytdSnitEmployee; }
            set { ytdSnitEmployee = value; }
        }
        public decimal YTDPFEmployee
        {
            get { return ytdPFEmployee; }
            set { ytdPFEmployee = value; }
        }

        public decimal YTDIncomeTax
        {
            get { return ytdIncomeTax; }
            set { ytdIncomeTax = value; }
        }

        public decimal YTDNetSalary
        {
            get { return ytdNetSalary; }
            set { ytdNetSalary = value; }
        }
    }
}
