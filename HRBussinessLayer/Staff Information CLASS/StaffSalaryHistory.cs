...
namespace HRBussinessLayer.Staff_Information_CLASS
{
    public class StaffSalaryHistory
    {
        ...
        private SalaryPaymentAccount salarypaymentaccount;
        ...
        public StaffSalaryHistory()
        {
            ...
            this.step = new Step();
            this.archived = false;
            this.salarypaymentaccount = new SalaryPaymentAccount();
        }
        ...
        public SalaryPaymentAccount salaryPaymentAccount {
            get { return this.salarypaymentaccount;}
            set { this.salarypaymentaccount=value; }
        }
    }

    public class SalaryPaymentAccount
    {

        public SalaryPaymentAccount()
        {
            this.ID = 0;
            this.Active = true;
            this.Archived = false;
